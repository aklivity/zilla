...
public class ApplicationIT
{
    ...
    @Test
    @Specification({
        "${app}/client.sent.avro.json.valid/client",
    ...
    @Test
    @Specification({
        "${app}/client.sent.avro.json.schema.violation/client",
        "${app}/client.sent.avro.json.schema.violation/server"
    })
    ...
    @Test
    @Specification({
        "${app}/client.sent.avro.binary.valid/client",
    ...
    @Test
    @Specification({
        "${app}/client.sent.avro.binary.truncated/client",
