 ...
 * under the License.
 */
package io.aklivity.zilla.specs.cog.kafka.internal;

import static io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaOffsetFW.Builder.DEFAULT_LATEST_OFFSET;
...
import io.aklivity.zilla.specs.cog.kafka.internal.types.Array32FW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaCapabilities;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaConditionFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaDeltaFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaDeltaType;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaFilterFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaHeaderFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaHeadersFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaKeyFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaNotFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaOffsetFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaOffsetType;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaSkip;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaSkipFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaValueFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.KafkaValueMatchFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.OctetsFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaApi;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaBeginExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaBootstrapBeginExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaDataExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaDescribeBeginExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaDescribeDataExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaFetchBeginExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaFetchDataExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaFetchFlushExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaFlushExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaMergedBeginExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaMergedDataExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaMergedFlushExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaMetaBeginExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaMetaDataExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaProduceBeginExFW;
import io.aklivity.zilla.specs.cog.kafka.internal.types.stream.KafkaProduceDataExFW;
