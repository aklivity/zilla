 ...
 */
package io.aklivity.zilla.specs.binding.mcp.kafka.connect.config;
...
public class SchemaTest
{
    ...
    public final ConfigSchemaRule schema = new ConfigSchemaRule()
        .schemaPatch("io/aklivity/zilla/specs/binding/mcp/kafka/connect/schema/mcp_kafka_connect.schema.patch.json")
