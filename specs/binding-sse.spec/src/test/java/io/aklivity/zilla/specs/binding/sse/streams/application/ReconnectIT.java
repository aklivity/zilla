...
public class ReconnectIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("app", "io/aklivity/zilla/specs/binding/sse/streams/application/reconnect");
    ...
    @Test
    @Specification({
        "${app}/last.event.id.end.fragmented/client",
    ...
    @Test
    @Specification({
        "${app}/initial.last.event.id/client",
