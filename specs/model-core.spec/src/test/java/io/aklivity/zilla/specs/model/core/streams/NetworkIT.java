...
public class NetworkIT
{
    ...
    @Specification({
        ...
        "${net}/client.sent.string.valid/server"
    })
    ...
    @Specification({
        ...
        "${net}/client.sent.string.matching.pattern/server"
    })
    ...
    @Specification({
        ...
        "${net}/client.sent.string.invalid.pattern/server"
    })
    ...
    @Specification({
        ...
        "${net}/client.sent.int32.invalid/server"
    })
    ...
    @Specification({
        ...
        "${net}/client.sent.int32.out.of.range/server"
    })
    ...
    @Specification({
        ...
        "${net}/client.sent.int32.lenient/server"
    })
    ...
    @Specification({
        ...
        "${net}/client.sent.int64.invalid/server"
    })
    ...
    @Specification({
        ...
        "${net}/client.sent.double.invalid/server"
    })
    ...
    @Specification({
        ...
        "${net}/client.sent.float.invalid/server"
    })
    ...
    @Specification({
        ...
        "${net}/client.sent.boolean/server"
    })
    ...
    @Specification({
        ...
        "${net}/client.sent.boolean.invalid/server"
    })
    ...
    @Specification({
        ...
        "${net}/client.sent.string.invalid.utf8/server"
    })
