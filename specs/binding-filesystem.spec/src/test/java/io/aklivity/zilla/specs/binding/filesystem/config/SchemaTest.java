 ...
 */
package io.aklivity.zilla.specs.binding.filesystem.config;
...
public class SchemaTest
{
    ...
    public final ConfigSchemaRule schema = new ConfigSchemaRule()
        .schemaPatch("io/aklivity/zilla/specs/binding/filesystem/schema/filesystem.schema.patch.json")
    ...
    {
        JsonObject config = schema.validate("server_symlinks.json");
