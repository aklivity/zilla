...
public class ApplicationIT
{
    ...
    @Test
    @Specification({
        "${app}/client.sent.protobuf.json.valid/client",
    ...
    @Test
    @Specification({
        "${app}/client.sent.protobuf.json.unknown.field/client",
        "${app}/client.sent.protobuf.json.unknown.field/server"
    })
    ...
    @Test
    @Specification({
        "${app}/client.sent.protobuf.binary.valid/client",
    ...
    @Test
    @Specification({
        "${app}/client.sent.protobuf.binary.truncated/client",
        "${app}/client.sent.protobuf.binary.truncated/server"
    })
    ...
    @Test
    @Specification({
        "${app}/client.received.protobuf.json.ext.uppercase/client",
    ...
    @Test
    @Specification({
        "${app}/client.received.protobuf.binary.ext.uppercase/client",
