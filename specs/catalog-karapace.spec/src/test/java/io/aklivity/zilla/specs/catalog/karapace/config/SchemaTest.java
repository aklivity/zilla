 ...
 */
package io.aklivity.zilla.specs.catalog.karapace.config;
...
public class SchemaTest
{
    ...
    public final ConfigSchemaRule schema = new ConfigSchemaRule()
        .schemaPatch("io/aklivity/zilla/config/catalog/schema/registry/schema/schema.registry.schema.patch.json")
        .schemaPatch("io/aklivity/zilla/config/catalog/karapace/schema/karapace.schema.patch.json")
