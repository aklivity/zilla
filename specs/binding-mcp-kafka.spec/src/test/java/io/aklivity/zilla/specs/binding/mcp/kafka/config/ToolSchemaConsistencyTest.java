...
public class ToolSchemaConsistencyTest
{
    ...
    // produce_message, create_acls and delete_acls are the only tools whose effective annotations match every MCP
    ...
    private static final Set<String> DEFAULT_ANNOTATIONS_ALLOWLIST = Set.of("produce_message", "create_acls", "delete_acls");
