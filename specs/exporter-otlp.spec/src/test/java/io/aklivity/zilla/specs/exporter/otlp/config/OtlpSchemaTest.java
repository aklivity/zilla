 ...
 */
package io.aklivity.zilla.specs.exporter.otlp.config;
...
public class OtlpSchemaTest
{
    @Rule
    public final ConfigSchemaRule schema = new ConfigSchemaRule()
        .schemaPatch("io/aklivity/zilla/config/exporter/otlp/schema/otlp.schema.patch.json")
    ...
    @Test
    public void shouldValidateSecureExporter()
    {
        JsonObject config = schema.validate("secure/zilla.yaml");
