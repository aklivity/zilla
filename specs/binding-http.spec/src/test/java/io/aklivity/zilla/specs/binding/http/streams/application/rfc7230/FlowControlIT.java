...
public class FlowControlIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("app", "io/aklivity/zilla/specs/binding/http/streams/application/rfc7230/flow.control");
    ...
    @Test
    @Specification({
        "${app}/request.sent.100k.message/client",
        "${app}/request.sent.100k.message/server"})
