...
public class MetadataSaslIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/specs/binding/kafka/streams/network/metadata.v5.sasl.handshake.v1");
    ...
    @Test
    @Specification({
        "${net}/topic.partition.info.sasl.plain/client",
        "${net}/topic.partition.info.sasl.plain/server" })
    public void shouldRequestTopicPartitionWithSaslPlain() throws Exception
    {
        k3po.finish();
    }
