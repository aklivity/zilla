...
public class OffsetCommitIT
{
    ...
    @Specification({
        ...
        "${app}/update.topic.partition.offsets/server"})
    ...
    @Specification({
        ...
        "${app}/update.unknown.topic.partition.offset/server"})
    ...
    @Test
    @Specification({
        "${app}/offset.commit.failed/client",
        "${app}/offset.commit.failed/server"})
    public void shouldHandleOffsetCommitFailed() throws Exception
    {
        k3po.finish();
    }
}
