...
public class InitProducerIdSaslIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net",
            "io/aklivity/zilla/specs/binding/kafka/streams/network/init.producer.id.v4.sasl.handshake.v1");
    ...
    @Test
    @Specification({
        "${net}/produce.new.id.sasl.plain/client",
    ...
    @Test
    @Specification({
        "${net}/produce.new.id.sasl.scram/client",
