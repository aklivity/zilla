...
import io.aklivity.zilla.specs.binding.proxy.internal.types.ProxyAddressInet4FW;
import io.aklivity.zilla.specs.binding.proxy.internal.types.ProxyAddressInet6FW;
import io.aklivity.zilla.specs.binding.proxy.internal.types.ProxyAddressInetFW;
import io.aklivity.zilla.specs.binding.proxy.internal.types.ProxyAddressNoneFW;
import io.aklivity.zilla.specs.binding.proxy.internal.types.ProxyAddressProtocol;
import io.aklivity.zilla.specs.binding.proxy.internal.types.ProxyAddressUnixFW;
import io.aklivity.zilla.specs.binding.proxy.internal.types.ProxyInfoFW;
import io.aklivity.zilla.specs.binding.proxy.internal.types.ProxyInfoType;
import io.aklivity.zilla.specs.binding.proxy.internal.types.ProxySecureInfoFW;
import io.aklivity.zilla.specs.binding.proxy.internal.types.ProxySecureInfoType;
import io.aklivity.zilla.specs.binding.proxy.internal.types.String16FW;
import io.aklivity.zilla.specs.binding.proxy.internal.types.String8FW;
...
public final class ProxyFunctions
{
    ...
    public static final class ProxyBeginExBuilder
    {
        ...
        public final class ProxyAddressInetBuilder
        {
            ...
            {
                final MutableDirectBuffer buffer = new SafeBuffer(new byte[128]);
        ...
        public final class ProxyAddressInet4Builder
        {
            ...
            {
                final MutableDirectBuffer buffer = new SafeBuffer(new byte[14]);
                addressRW.wrap(buffer, 0, buffer.capacity());
        ...
        public final class ProxyAddressInet6Builder
        {
            ...
            {
                final MutableDirectBuffer buffer = new SafeBuffer(new byte[38]);
                addressRW.wrap(buffer, 0, buffer.capacity());
        ...
        public final class ProxyAddressUnixBuilder
        {
            ...
            {
                final MutableDirectBuffer buffer = new SafeBuffer(new byte[218]);
                addressRW.wrap(buffer, 0, buffer.capacity());
            ...
            public ProxyAddressUnixBuilder source(
                String source) throws UnknownHostException
            {
                MutableDirectBuffer sourceBuf = new SafeBuffer(new byte[108]);
            ...
            public ProxyAddressUnixBuilder destination(
                String destination) throws UnknownHostException
            {
                MutableDirectBuffer destinationBuf = new SafeBuffer(new byte[108]);
        ...
        public final class ProxyAddressNoneBuilder
        {
            ...
            {
                final MutableDirectBuffer buffer = new SafeBuffer(new byte[1]);
                addressRW.wrap(buffer, 0, buffer.capacity());
        ...
        public final class ProxyInfoBuilder
        {
            ...
            {
                final MutableDirectBuffer buffer = new SafeBuffer(new byte[1024]);
    ...
    public static final class ProxyBeginExMatcherBuilder
    {
        ...
        public final class ProxyAddressInet4MatcherBuilder
        {
                ...
                String source) throws UnknownHostException
            {
                final InetAddress inet = InetAddress.getByName(source);
                final byte[] ip = inet.getAddress();
                this.source = new OctetsFW().wrap(new SafeBuffer(ip), 0, ip.length);
                return this;
            }
                ...
                String destination) throws UnknownHostException
            {
                final InetAddress inet = InetAddress.getByName(destination);
                final byte[] ip = inet.getAddress();
                this.destination = new OctetsFW().wrap(new SafeBuffer(ip), 0, ip.length);
                return this;
            }
        ...
        public final class ProxyAddressUnixMatcherBuilder
        {
            ...
            public ProxyAddressUnixMatcherBuilder source(
                String source)
            {
                final MutableDirectBuffer sourceBuf = new SafeBuffer(new byte[108]);
                sourceBuf.putStringWithoutLengthUtf8(0, source);
            ...
            public ProxyAddressUnixMatcherBuilder destination(
                String destination)
            {
                final MutableDirectBuffer destinationBuf = new SafeBuffer(new byte[108]);
                destinationBuf.putStringWithoutLengthUtf8(0, destination);
        ...
        public final class ProxyInfoMatcherBuilder
        {
            ...
            public ProxyInfoMatcherBuilder identity(
                byte[] identity)
            {
                final DirectBuffer identityBuf = new SafeBuffer(identity);
