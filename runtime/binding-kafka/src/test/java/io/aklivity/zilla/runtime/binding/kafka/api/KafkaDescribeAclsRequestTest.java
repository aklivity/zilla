...
import io.aklivity.zilla.runtime.binding.kafka.api.KafkaDescribeAclsRequest.Generator;
import io.aklivity.zilla.runtime.binding.kafka.api.KafkaDescribeAclsRequest.Source;
import io.aklivity.zilla.runtime.common.agrona.buffer.MutableDirectBufferEx;
import io.aklivity.zilla.runtime.common.agrona.buffer.UnsafeBufferEx;

public class KafkaDescribeAclsRequestTest
{
    // body bytes only, as verified against the DescribeAcls v2 wire encoder output (RequestHeader
    ...
    public void shouldGenerateFromSourceMatchingGoldenBytes()
    {
        FakeSource source = new FakeSource(
            KafkaAclTypes.RESOURCE_TYPE_TOPIC, "events", KafkaAclTypes.PATTERN_TYPE_LITERAL,
            "User:alice", null, KafkaAclTypes.OPERATION_READ, KafkaAclTypes.PERMISSION_TYPE_ALLOW);
    ...
    public void shouldComputeSizeofMatchingGoldenBytes()
    {
        ...
        assertEquals(EXPECTED.length, KafkaDescribeAclsRequest.sizeof(source, (short) 2));
    }
    ...
    {
        FakeSource source = new FakeSource(
            KafkaAclTypes.RESOURCE_TYPE_ANY, null, KafkaAclTypes.PATTERN_TYPE_ANY,
        ...
        assertTrue(generator.generate(source));
        assertEquals(generator.limit(), KafkaDescribeAclsRequest.sizeof(source, (short) 2));
    }
    ...
    {
        FakeSource source = new FakeSource(
            KafkaAclTypes.RESOURCE_TYPE_TOPIC, "events-resource-name-too-long-to-fit-in-a-tiny-buffer",
            KafkaAclTypes.PATTERN_TYPE_LITERAL, null, null, KafkaAclTypes.OPERATION_READ,
    ...
    public void shouldRejectUnsupportedApiVersion()
    {
        ...
        assertThrows(UnsupportedOperationException.class, () -> KafkaDescribeAclsRequest.sizeof(source, (short) 1));
    }
    ...
    private record FakeSource(
        ...
        String host,
        byte operation,
        byte permissionType) implements Source
    {
    }
}
