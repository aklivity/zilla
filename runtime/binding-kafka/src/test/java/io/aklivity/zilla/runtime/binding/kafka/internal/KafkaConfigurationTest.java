...
import static io.aklivity.zilla.runtime.binding.kafka.internal.KafkaConfiguration.KAFKA_CLIENT_CONNECTION_POLL_CLEANUP_MILLIS;
...
public class KafkaConfigurationTest
{
    ...
    public void shouldVerifyConstants() throws Exception
    {
        ...
        assertEquals(KAFKA_CLIENT_CONNECTION_POLL_CLEANUP_MILLIS.name(), KAFKA_CLIENT_CONNECTION_POLL_CLEANUP_MILLIS_NAME);
