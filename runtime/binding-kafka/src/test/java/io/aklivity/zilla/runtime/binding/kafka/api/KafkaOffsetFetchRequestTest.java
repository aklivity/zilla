...
import io.aklivity.zilla.runtime.binding.kafka.api.KafkaOffsetFetchRequest.Generator;
import io.aklivity.zilla.runtime.common.agrona.buffer.MutableDirectBufferEx;
import io.aklivity.zilla.runtime.common.agrona.buffer.UnsafeBufferEx;

public class KafkaOffsetFetchRequestTest
{
    // body bytes only, as verified against the real Kafka OffsetFetch v6 wire encoder output
    ...
    private static final byte[] EXPECTED = new byte[]
    {
        ...
        0x09, 'm', 'y', '-', 'g', 'r', 'o', 'u', 'p', // groupId
        0x00, // topicCount = null (all topics)
        0x00 // request tagged fields
    };

    @Test
    public void shouldGenerateOffsetFetchV6Request()
    {
    ...
    {
        assertEquals(EXPECTED.length, KafkaOffsetFetchRequest.sizeof("my-group", (short) 6));
    }
    ...
    {
        assertThrows(UnsupportedOperationException.class, () -> KafkaOffsetFetchRequest.sizeof("my-group", (short) 5));
    }
}
