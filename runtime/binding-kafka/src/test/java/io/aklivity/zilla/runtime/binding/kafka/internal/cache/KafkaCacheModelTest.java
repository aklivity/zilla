...
public class KafkaCacheModelTest
{
    ...
    {
        KafkaCacheModel model = KafkaCacheModel.decoder(handler(5), new UnsafeBufferEx(new byte[256]));
    ...
    {
        KafkaCacheModel model = KafkaCacheModel.decoder(handler(5, 8), new UnsafeBufferEx(new byte[256]));
    ...
    {
        KafkaCacheModel model = KafkaCacheModel.decoder(handler(5, 3), new UnsafeBufferEx(new byte[256]));
    ...
    {
        KafkaCacheModel model = KafkaCacheModel.decoder(handler(5), new UnsafeBufferEx(new byte[2]));
    ...
    {
        assertSame(KafkaCacheModel.NONE, KafkaCacheModel.decoder(null, new UnsafeBufferEx(new byte[8])));
