...
public final class KafkaCachePartition
{
        ...
        boolean verbose)
    {
        ...
        else
        {
            ...
            int converted = convertKey.convert(context.supplyTraceId(), bindingId,
        ...
        ConverterHandler convertValue)
    {
        ...
        write:
        {
            ...
            else
            {
                ...
                converted = convertKey.convert(context.supplyTraceId(), bindingId,
                    value.buffer(), value.offset(), value.sizeof(), writeKey);
        ...
        ConverterHandler convertValue)
    {
        ...
        if (payload != null)
        {
            ...
            if (convertValue != ConverterHandler.NONE)
            {
                ...
                {
                    converted = convertValue.convert(context.supplyTraceId(), bindingId,
                        logFile.buffer(), valueMark.value, valueLength, consumeConverted);
                }
            }
        }
