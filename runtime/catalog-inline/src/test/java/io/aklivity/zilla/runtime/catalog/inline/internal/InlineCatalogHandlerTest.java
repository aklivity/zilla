...
public class InlineCatalogHandlerTest
{
    ...
    public void shouldResolveLiteralSubjectAgainstWildcardRegisteredSubject()
    {
        ...
        assertThat(handler.resolve("orders.created-value", "latest"), equalTo(schemaId));
        assertThat(handler.resolve("orders.updated-value", "latest"), equalTo(schemaId));
    }
    ...
    public void shouldNotMatchWildcardRegisteredSubjectWithDifferentPrefix()
    {
        ...
        assertThat(handler.resolve("shipments.created-value", "latest"), equalTo(NO_SCHEMA_ID));
    }
    ...
    public void shouldNotMatchWildcardRegisteredSubjectWithDifferentSuffix()
    {
        ...
        assertThat(handler.resolve("orders.created-key", "latest"), equalTo(NO_SCHEMA_ID));
    }
    ...
    public void shouldNotMatchWildcardRegisteredSubjectWithDifferentVersion()
    {
        ...
        assertThat(handler.resolve("orders.created-value", "v2"), equalTo(NO_SCHEMA_ID));
    }
    ...
    public void shouldPreferExactMatchOverWildcardRegisteredSubject()
    {
        ...
        handler.register("orders.*-value", SCHEMA_A);
        int exact = handler.register("orders.created-value", SCHEMA_B);

        assertThat(handler.resolve("orders.created-value", "latest"), equalTo(exact));
    ...
    public void shouldStopMatchingWildcardRegisteredSubjectAfterUnregister()
    {
        ...
        assertThat(handler.resolve("orders.created-value", "latest"), equalTo(NO_SCHEMA_ID));
    }
}
