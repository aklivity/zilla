 ...
 * under the License.
 */
package io.aklivity.zilla.runtime.cog.proxy.internal.streams;
...
public class ProxyClientIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("app", "io/aklivity/zilla/specs/cog/proxy/streams/application")
        .addScriptRoot("net", "io/aklivity/zilla/specs/cog/proxy/streams/network.v2");
    ...
    @Configure(name = "zilla.engine.host.resolver",
               value = "io.aklivity.zilla.runtime.cog.proxy.internal.streams.ProxyClientIT::resolveInet4")
    ...
    @Configure(name = "zilla.engine.host.resolver",
               value = "io.aklivity.zilla.runtime.cog.proxy.internal.streams.ProxyClientIT::resolveInet6")
