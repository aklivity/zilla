...
public class ClosingHandshakeIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/specs/binding/ws/streams/network/closing")
        .addScriptRoot("app", "io/aklivity/zilla/specs/binding/ws/streams/application/closing");
