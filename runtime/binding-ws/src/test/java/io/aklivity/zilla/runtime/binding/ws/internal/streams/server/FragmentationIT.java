...
public class FragmentationIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/specs/binding/ws/streams/network/fragmentation")
        .addScriptRoot("app", "io/aklivity/zilla/specs/binding/ws/streams/application/fragmentation");
