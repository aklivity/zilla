        ...
        if (length > 0)
        {
            ...
            decode:
            {
                ...
                case 5:
                    ...
                    clientId = mqttConnectV5.clientId();
        ...
        final int limit)
    {
        ...
        if (length > 0)
        {
            ...
            case 5:
                ...
                if (reasonCode == 0)
                {
                    packetId = unsubscribeV5.packetId();
                    payload = unsubscribeV5.payload();
            ...
            if (reasonCode == 0)
            {
                server.onDecodeUnsubscribe(traceId, authorization, packetId, payload);
                server.decoder = decodePacketType;
            }
            else
            {
