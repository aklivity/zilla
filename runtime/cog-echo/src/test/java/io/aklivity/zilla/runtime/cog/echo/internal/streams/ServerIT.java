 ...
 * under the License.
 */
package io.aklivity.zilla.runtime.cog.echo.internal.streams;
...
public class ServerIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("streams", "io/aklivity/zilla/specs/cog/echo/streams/rfc862");
    ...
    private final EngineRule engine = new EngineRule()
        ...
        .configurationRoot("io/aklivity/zilla/specs/cog/echo/config")
        .clean();
