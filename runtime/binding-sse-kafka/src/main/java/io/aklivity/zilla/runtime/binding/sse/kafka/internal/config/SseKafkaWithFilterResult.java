...
public final class SseKafkaWithFilterResult
{
    public final DirectBuffer key;
    public final List<SseKafkaWithFilterHeaderResult> headers;

    SseKafkaWithFilterResult(
        DirectBuffer key,
        List<SseKafkaWithFilterHeaderResult> headers)
    {
        this.key = key;
