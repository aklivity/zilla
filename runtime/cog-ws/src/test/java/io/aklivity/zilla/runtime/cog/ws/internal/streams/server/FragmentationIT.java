...
public class FragmentationIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/specs/cog/ws/streams/network/fragmentation")
        .addScriptRoot("app", "io/aklivity/zilla/specs/cog/ws/streams/application/fragmentation");
