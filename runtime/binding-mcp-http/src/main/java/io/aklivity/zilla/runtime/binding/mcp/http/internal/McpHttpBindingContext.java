...
{
    private final Map<KindConfig, McpHttpProxyFactory> factories;

    McpHttpBindingContext(
        McpHttpConfiguration config,
        EngineContext context)
    {
        this.factories = singletonMap(PROXY, new McpHttpProxyFactory(config, context));
    }
    ...
    {
        final McpHttpProxyFactory factory = factories.get(binding.kind);
