...
public final class McpHttpEventFormatterFactory implements EventFormatterFactorySpi
{
    @Override
    public McpHttpEventFormatter create(
        Configuration config)
    {
        return new McpHttpEventFormatter(config);
    }
