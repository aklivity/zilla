...
public final class OpenapiAsyncapiEventFormatterFactory implements EventFormatterFactorySpi
{
    @Override
    public OpenapiAsyncapiEventFormatter create(
        Configuration config)
    {
        return new OpenapiAsyncapiEventFormatter(config);
    }
