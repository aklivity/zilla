 ...
 * protobuf model, participating in schema-bound pipeline construction alongside model-protobuf's own stages.
 * <p>
...
public interface ProtobufModelExtFactorySpi
{
     ...
     * @return a new {@link ProtobufModelExt}
     */
    ProtobufModelExt create(
