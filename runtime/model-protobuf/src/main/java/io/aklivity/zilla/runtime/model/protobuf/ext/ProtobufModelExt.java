...
/**
 * One installed protobuf model extension, created once per {@link io.aklivity.zilla.runtime.engine.Configuration}
 * by its {@link ProtobufModelExtFactorySpi}. {@link #supply(EngineContext)} is called once per engine worker,
...
public interface ProtobufModelExt
{
     ...
     * @return the per-worker {@link ProtobufModelExtContext}
     */
    ProtobufModelExtContext supply(
