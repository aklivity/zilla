...
public final class McpOpenapiEventFormatterFactory implements EventFormatterFactorySpi
{
    @Override
    public McpOpenapiEventFormatter create(
        Configuration config)
    {
        return new McpOpenapiEventFormatter(config);
    }
