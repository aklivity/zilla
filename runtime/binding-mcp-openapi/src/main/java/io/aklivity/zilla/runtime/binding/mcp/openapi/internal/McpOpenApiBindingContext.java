...
{
    private final Map<KindConfig, McpOpenApiProxyFactory> factories;

    McpOpenApiBindingContext(
        McpOpenApiConfiguration config,
        EngineContext context)
    {
        Map<KindConfig, McpOpenApiProxyFactory> factories = new EnumMap<>(KindConfig.class);
    ...
    {
        McpOpenApiProxyFactory factory = factories.get(binding.kind);
