...
public final class McpOpenapiCompositeConfig
{
    ...
    public final List<McpOpenapiCompositeRouteConfig> routes;

    public McpOpenapiCompositeConfig(
        List<NamespaceConfig> namespaces,
        List<McpOpenapiCompositeRouteConfig> routes)
    {
        this.namespaces = namespaces;
        this.routes = routes;
    }

    public McpOpenapiCompositeRouteConfig resolve()
    {
