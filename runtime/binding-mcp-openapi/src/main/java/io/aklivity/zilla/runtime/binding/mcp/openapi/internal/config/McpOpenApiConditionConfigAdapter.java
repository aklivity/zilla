    ...
    JsonbAdapter<ConditionConfig, JsonObject>
{
    ...
    {
        McpOpenApiConditionConfig mcpCondition = (McpOpenApiConditionConfig) condition;
        JsonObjectBuilder object = Json.createObjectBuilder();

        if (mcpCondition.tool != null)
        {
            object.add(TOOL_NAME, mcpCondition.tool);
        }

        if (mcpCondition.resource != null)
        {
            object.add(RESOURCE_NAME, mcpCondition.resource);
        }
