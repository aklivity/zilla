...
public class ChallengeIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/specs/binding/sse/streams/network/challenge")
        .addScriptRoot("app", "io/aklivity/zilla/specs/binding/sse/streams/application/challenge");
