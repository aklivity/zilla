...
public final class McpAsyncApiWithConfigAdapter implements WithConfigAdapterSpi, JsonbAdapter<WithConfig, JsonObject>
{
    ...
    public JsonObject adaptToJson(
        WithConfig with)
    {
        McpAsyncApiWithConfig config = (McpAsyncApiWithConfig) with;
        ...
        JsonObject object)
    {
        ...
        return new McpAsyncApiWithConfig(apiId, operationId);
    }
}
