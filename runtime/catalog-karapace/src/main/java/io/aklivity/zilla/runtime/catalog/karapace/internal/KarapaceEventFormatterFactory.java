...
public final class KarapaceEventFormatterFactory implements EventFormatterFactorySpi
{
    @Override
    public KarapaceEventFormatter create(
        Configuration config)
    {
        return new KarapaceEventFormatter(config);
    }
