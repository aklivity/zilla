...
public class WatchedConfig
{
    ...
    public WatchedConfig(URL configURL, WatchService watchService)
    {
    ...
    public void cancelKeys(Map<WatchKey, WatchedConfig> watchedConfigsByKey)
    {
    ...
    private static Path toRealPath(
        Path configPath)
    {
        try
        {
