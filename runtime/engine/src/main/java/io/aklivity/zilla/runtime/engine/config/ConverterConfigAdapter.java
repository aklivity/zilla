...
public final class ConverterConfigAdapter implements JsonbAdapter<ConverterConfig, JsonValue>
{
    private static final String TYPE_NAME = "type";

    private final Map<String, ConverterConfigAdapterSpi> delegatesByName;
