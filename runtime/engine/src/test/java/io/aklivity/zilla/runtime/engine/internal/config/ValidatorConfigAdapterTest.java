...
public class ValidatorConfigAdapterTest
{
    ...
    public void shouldReadValidator()
    {
        ...
        // WHEN
        ValidatorConfig config = jsonb.fromJson(json, ValidatorConfig.class);

        // THEN
        assertThat(config, not(nullValue()));
        assertThat(config.type, equalTo("test"));
    }
    ...
    public void shouldWriteValidator()
    {
        ...
        ValidatorConfig config = TestValidatorConfig.builder().build();
