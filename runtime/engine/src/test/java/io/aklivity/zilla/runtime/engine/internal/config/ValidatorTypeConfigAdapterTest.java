...
public class ValidatorTypeConfigAdapterTest
{
    ...
    public void initJson()
    {
        JsonbConfig config = new JsonbConfig()
            .withAdapters(new ValidatorTypeConfigAdapter(), new SchemaConfigAdapter());
    ...
    public void shouldReadFullSyntax()
    {
        ...
        // THEN
        assertThat(validatorType, not(nullValue()));
        assertThat(validatorType.type, equalTo(ValidatorTypeConfig.Type.AVRO));
    ...
    public void shouldWriteFullSyntax()
    {
        ...
        ValidatorTypeConfig validatorType = new ValidatorTypeConfig(ValidatorTypeConfig.Type.AVRO, catalog);
