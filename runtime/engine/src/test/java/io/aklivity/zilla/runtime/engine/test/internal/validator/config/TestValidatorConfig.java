...
public class TestValidatorConfig extends ValidatorConfig
{
    ...
    {
        return new TestValidatorConfigBuilder<>(mapper);
    }

    public static TestValidatorConfigBuilder<TestValidatorConfig> builder()
    {
        return new TestValidatorConfigBuilder<>(TestValidatorConfig.class::cast);
    }
}
