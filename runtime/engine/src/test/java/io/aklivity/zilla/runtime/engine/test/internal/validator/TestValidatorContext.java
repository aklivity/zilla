...
public class TestValidatorContext implements ValidatorContext
{
    public TestValidatorContext(EngineContext context)
    {
    }
    ...
    {
        return new TestValidatorHandler(TestValidatorConfig.class.cast(config));
    }
}
