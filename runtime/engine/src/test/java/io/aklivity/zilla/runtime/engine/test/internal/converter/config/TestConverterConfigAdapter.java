...
public class TestConverterConfigAdapter implements ConverterConfigAdapterSpi, JsonbAdapter<ConverterConfig, JsonValue>
{
    ...
    @Override
    public TestConverterConfig adaptFromJson(
        JsonValue value)
    {
        ...
        return new TestConverterConfig(length, catalogs, read);
    }
}
