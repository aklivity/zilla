 ...
 * under the License.
 */
package io.aklivity.zilla.runtime.engine.internal.converter.config;
...
public class ConverterConfigAdapterTest
{
    private Jsonb jsonb;
    ...
    {
        ConverterConfigAdapter adapter = new ConverterConfigAdapter();
    ...
    public void shouldReadConverter()
    {
        ...
        // WHEN
        ConverterConfig converter = jsonb.fromJson(json, ConverterConfig.class);
