...
import static io.aklivity.zilla.runtime.cog.http2.internal.stream.Http2Flags.ACK;
import static io.aklivity.zilla.runtime.cog.http2.internal.types.Http2FrameType.SETTINGS;
import static io.aklivity.zilla.runtime.cog.http2.internal.types.Http2Setting.ENABLE_PUSH;
import static io.aklivity.zilla.runtime.cog.http2.internal.types.Http2Setting.HEADER_TABLE_SIZE;
import static io.aklivity.zilla.runtime.cog.http2.internal.types.Http2Setting.INITIAL_WINDOW_SIZE;
import static io.aklivity.zilla.runtime.cog.http2.internal.types.Http2Setting.MAX_CONCURRENT_STREAMS;
import static io.aklivity.zilla.runtime.cog.http2.internal.types.Http2Setting.MAX_FRAME_SIZE;
import static io.aklivity.zilla.runtime.cog.http2.internal.types.Http2Setting.MAX_HEADER_LIST_SIZE;
...
import io.aklivity.zilla.runtime.cog.http2.internal.util.function.ObjectIntBiConsumer;
