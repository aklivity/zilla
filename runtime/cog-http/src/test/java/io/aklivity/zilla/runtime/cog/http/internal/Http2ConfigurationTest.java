...
import static io.aklivity.zilla.runtime.cog.http.internal.Http2Configuration.HTTP2_ACCESS_CONTROL_ALLOW_ORIGIN;
import static io.aklivity.zilla.runtime.cog.http.internal.Http2Configuration.HTTP2_MAX_CONCURRENT_STREAMS_CLEANUP;
import static io.aklivity.zilla.runtime.cog.http.internal.Http2Configuration.HTTP2_SERVER_CONCURRENT_STREAMS;
import static io.aklivity.zilla.runtime.cog.http.internal.Http2Configuration.HTTP2_SERVER_HEADER;
import static io.aklivity.zilla.runtime.cog.http.internal.Http2Configuration.HTTP2_SERVER_MAX_HEADER_LIST_SIZE;
import static io.aklivity.zilla.runtime.cog.http.internal.Http2Configuration.HTTP2_STREAMS_CLEANUP_DELAY;
