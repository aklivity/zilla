...
import static io.aklivity.zilla.runtime.cog.http2.internal.Http2ConfigurationTest.HTTP2_MAX_CONCURRENT_STREAMS_CLEANUP_NAME;
import static io.aklivity.zilla.runtime.cog.http2.internal.Http2ConfigurationTest.HTTP2_STREAMS_CLEANUP_DELAY_NAME;
...
public class ConnectionManagementIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/specs/cog/http2/streams/network/rfc7540/connection.management")
