...
// Per-stream write transform session vended by AvroWriteModelHandler: owns its own schema-keyed pipeline
...
{
    private final AvroWriteModelHandler handler;
