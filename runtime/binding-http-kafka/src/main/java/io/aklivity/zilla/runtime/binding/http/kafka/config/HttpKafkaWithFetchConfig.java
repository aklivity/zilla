...
public final class HttpKafkaWithFetchConfig
{
    ...
    public static HttpKafkaWithFetchConfigBuilder<HttpKafkaWithFetchConfig> builder()
    {
        return new HttpKafkaWithFetchConfigBuilder<>(HttpKafkaWithFetchConfig.class::cast);
    }

    public static <T> HttpKafkaWithFetchConfigBuilder<T> builder(
        Function<HttpKafkaWithFetchConfig, T> mapper)
    {
        return new HttpKafkaWithFetchConfigBuilder<>(mapper);
    }
