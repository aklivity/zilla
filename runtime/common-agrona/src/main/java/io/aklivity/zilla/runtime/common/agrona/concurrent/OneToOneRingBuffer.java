 ...
 */
public class OneToOneRingBuffer implements RingBufferEx
{
    /**
    ...
    /**
     * Construct a new {@link OneToOneRingBuffer} based on an underlying {@link AtomicBufferEx}.
     ...
     */
    public OneToOneRingBuffer(final AtomicBufferEx buffer)
    {
     ...
     * {@inheritDoc}
     */
    public boolean write(final int msgTypeId, final DirectBufferEx srcBuffer, final int offset, final int length)
    {
        checkTypeId(msgTypeId);
        checkMsgLength(length);
