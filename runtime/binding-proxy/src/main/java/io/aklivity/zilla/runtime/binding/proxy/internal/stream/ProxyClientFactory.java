...
import io.aklivity.zilla.runtime.binding.proxy.internal.config.ProxyRouteConfig;
...
import io.aklivity.zilla.runtime.binding.proxy.internal.types.ProxyAddressInet4FW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.ProxyAddressInet6FW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.ProxyAddressInetFW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.ProxyAddressUnixFW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.ProxyInfoFW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.ProxySecureInfoFW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.codec.ProxyTlvFW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.stream.AbortFW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.stream.BeginFW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.stream.ChallengeFW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.stream.DataFW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.stream.EndFW;
import io.aklivity.zilla.runtime.binding.proxy.internal.types.stream.FlushFW;
...
public final class ProxyClientFactory implements ProxyStreamFactory
{
        ...
        MessageConsumer sender)
    {
        ...
        if (resolved != null)
        {
            newStream = new ProxyAppClient(originId, routedId, initialId, sender, resolved.id)::onAppMessage;
        }
    ...
    private final class ProxyAppClient
    {
            ...
            long resolvedId)
        {
            ...
            this.net = new ProxyNetClient(this, routedId, resolvedId);
        }
    ...
    private final class ProxyNetClient
    {
            ...
            ProxyBeginExFW beginEx)
        {
            ...
            receiver = newStream(this::onNetMessage, originId, routedId, initialId, initialSeq, initialAck, initialMax,
                    traceId, authorization, affinity);
        }
        ...
        private void doNetChallenge(
            ...
            OctetsFW extension)
        {
            doChallenge(receiver, originId, routedId, replyId, replySeq, replyAck, replyMax,
                    traceId, authorization, extension);
        }
