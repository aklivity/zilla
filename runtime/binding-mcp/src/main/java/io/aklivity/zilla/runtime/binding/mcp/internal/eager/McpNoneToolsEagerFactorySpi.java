...
public final class McpNoneToolsEagerFactorySpi implements McpToolsEagerFactorySpi
{
    @Override
    public String type()
    {
        return McpNoneToolsEagerConfig.NAME;
    }
    ...
    {
        return new McpNoneToolsEager(context::dispatch);
    }
}
