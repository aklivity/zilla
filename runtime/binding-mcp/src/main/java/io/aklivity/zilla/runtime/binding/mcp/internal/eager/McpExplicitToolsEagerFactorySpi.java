...
public final class McpExplicitToolsEagerFactorySpi implements McpToolsEagerFactorySpi
{
    @Override
    public String type()
    {
        return McpExplicitToolsEagerConfig.NAME;
    }
    ...
    {
        McpExplicitToolsEagerConfig explicit = (McpExplicitToolsEagerConfig) config;
        return new McpExplicitToolsEager(context::dispatch, explicit.match);
    }
}
