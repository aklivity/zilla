...
public final class McpConditionConfig extends ConditionConfig
{
    ...
    {
        return new McpConditionConfigBuilder<>(McpConditionConfig.class::cast);
    }

    public static <T> McpConditionConfigBuilder<T> builder(
        Function<ConditionConfig, T> mapper)
    {
        return new McpConditionConfigBuilder<>(mapper);
    }
}
