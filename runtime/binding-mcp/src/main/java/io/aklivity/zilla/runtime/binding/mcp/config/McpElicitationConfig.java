...
public final class McpElicitationConfig
{
    ...
    {
        return new McpElicitationConfigBuilder<>(Function.identity());
    }

    public static <T> McpElicitationConfigBuilder<T> builder(
        Function<McpElicitationConfig, T> mapper)
    {
        return new McpElicitationConfigBuilder<>(mapper);
    }
}
