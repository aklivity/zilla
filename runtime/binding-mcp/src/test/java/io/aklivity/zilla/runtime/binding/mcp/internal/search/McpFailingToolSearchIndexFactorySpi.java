...
public final class McpFailingToolSearchIndexFactorySpi implements McpToolSearchIndexFactorySpi
{
    @Override
    public String type()
    {
        return McpFailingToolSearchIndexConfig.NAME;
    }
    ...
    {
        return new McpFailingToolSearchIndex(context::dispatch);
    }
}
