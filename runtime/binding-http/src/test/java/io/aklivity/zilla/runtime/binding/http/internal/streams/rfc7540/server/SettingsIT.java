...
import static io.aklivity.zilla.runtime.binding.http.internal.HttpConfigurationTest.HTTP_REMOTE_MAX_HEADER_LIST_SIZE_NAME;
...
public class SettingsIT
{
    ...
    @Configure(name = HTTP_REMOTE_CONCURRENT_STREAMS_NAME, value = "250")
    ...
    @Configure(name = HTTP_REMOTE_MAX_HEADER_LIST_SIZE_NAME, value = "4096")
