...
public class RedirectIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/specs/binding/http/streams/network/rfc7540/redirect")
        .addScriptRoot("app", "io/aklivity/zilla/specs/binding/http/streams/application/rfc7540/redirect");
    ...
    private final EngineRule engine = new EngineRule()
        ...
        .configure(HTTP_STREAM_INITIAL_WINDOW, 8192)
