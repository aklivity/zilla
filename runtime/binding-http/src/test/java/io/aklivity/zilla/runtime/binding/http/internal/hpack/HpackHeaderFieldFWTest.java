...
import static io.aklivity.zilla.runtime.binding.http.internal.hpack.HpackHeaderFieldFW.HeaderFieldType.LITERAL;
...
import static io.aklivity.zilla.runtime.binding.http.internal.hpack.HpackLiteralHeaderFieldFW.LiteralType.NEVER_INDEXED;
...
import static io.aklivity.zilla.runtime.binding.http.internal.hpack.HpackLiteralHeaderFieldFW.NameType.INDEXED;
import static io.aklivity.zilla.runtime.binding.http.internal.hpack.HpackLiteralHeaderFieldFW.NameType.NEW;
...
public class HpackHeaderFieldFWTest
{
    ...
    public void decodeC21()
    {
        byte[] bytes = BitUtil.fromHex(
                "00" +  // +00 to test offset
                        ...
                        // Header field  end
                        "00");
        DirectBufferEx buf = new UnsafeBufferEx(bytes);
    ...
    {
        DirectBufferEx password = new UnsafeBufferEx("password".getBytes(UTF_8));
        DirectBufferEx secret = new UnsafeBufferEx("secret".getBytes(UTF_8));
