...
public class BufferUtilTest
{
    ...
    {
        DirectBuffer buffer2 = new SafeBuffer("a nice warm cookie cutter".getBytes(US_ASCII));
    ...
    {
        DirectBuffer buffer1 = new SafeBuffer("".getBytes(US_ASCII));
        DirectBuffer buffer2 = new SafeBuffer("get / HTTP/1.1\r\n\r\n".getBytes(US_ASCII));
    ...
    {
        DirectBuffer buffer1 = new SafeBuffer("...\r\n\r".getBytes(US_ASCII));
        DirectBuffer buffer2 = new SafeBuffer("\n....".getBytes(US_ASCII));
    ...
    {
        DirectBuffer buffer1 = new SafeBuffer("..\r".getBytes(US_ASCII));
        DirectBuffer buffer2 = new SafeBuffer("\n\r\n....".getBytes(US_ASCII));
