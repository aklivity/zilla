...
public class BufferUtilTest
{
    ...
    {
        DirectBuffer buffer2 = new UnsafeBufferEx("a nice warm cookie cutter".getBytes(US_ASCII));
    ...
    {
        DirectBuffer buffer1 = new UnsafeBufferEx("".getBytes(US_ASCII));
        DirectBuffer buffer2 = new UnsafeBufferEx("get / HTTP/1.1\r\n\r\n".getBytes(US_ASCII));
    ...
    {
        DirectBuffer buffer1 = new UnsafeBufferEx("...\r\n\r".getBytes(US_ASCII));
        DirectBuffer buffer2 = new UnsafeBufferEx("\n....".getBytes(US_ASCII));
    ...
    {
        DirectBuffer buffer1 = new UnsafeBufferEx("..\r".getBytes(US_ASCII));
        DirectBuffer buffer2 = new UnsafeBufferEx("\n\r\n....".getBytes(US_ASCII));
