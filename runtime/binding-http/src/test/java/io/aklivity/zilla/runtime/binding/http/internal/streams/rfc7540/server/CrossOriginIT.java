...
public class CrossOriginIT
{
    ...
    @Test
    @Configuration("server.cors.json")
    @Specification({
        "${net}/allow.credentials.explicit.header/client",
        "${app}/allow.credentials/server" })
    public void shouldAllowCredentialsWithExplicitHeader() throws Exception
    {
        k3po.finish();
    }
}
