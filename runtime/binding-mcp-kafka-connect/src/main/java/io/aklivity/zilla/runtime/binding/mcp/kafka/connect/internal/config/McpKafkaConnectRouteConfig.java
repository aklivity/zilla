...
public final class McpKafkaConnectRouteConfig
{
    public final long id;
    public final List<McpKafkaConnectConditionConfig> when;
    public final List<GuardedConfig> guarded;

    public McpKafkaConnectRouteConfig(
        RouteConfig route)
    {
        this.id = route.id;
        this.when = route.when.stream()
            .map(McpKafkaConnectConditionConfig.class::cast)
            .collect(toList());
