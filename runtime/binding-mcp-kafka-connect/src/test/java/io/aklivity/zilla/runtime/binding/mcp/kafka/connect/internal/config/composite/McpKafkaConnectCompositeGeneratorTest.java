...
public class McpKafkaConnectCompositeGeneratorTest
{
    ...
    public void shouldGenerateComposite()
    {
        ...
        assertThat(schema.subject, equalTo("kafkaconnect"));
        ...
        assertThat(spec.label, equalTo("kafkaconnect"));
        ...
        assertThat(specCatalog.subject, equalTo("kafkaconnect"));
        ...
        for (int i = 0; i < TOOLS.size(); i++)
        {
            ...
            assertThat(with.spec, equalTo("kafkaconnect"));
