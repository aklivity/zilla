...
public class OpenapiWithConfigAdapterTest
{
    private Jsonb jsonb;
    ...
    public void initJson()
    {
        JsonbConfig config = new JsonbConfig()
                .withAdapters(new OpenapiWithConfigAdapter());
    ...
    public void shouldReadWith()
    {
        ...
        OpenapiWithConfig with = jsonb.fromJson(text, OpenapiWithConfig.class);

        assertThat(with, not(nullValue()));
        assertThat(with.spec, equalTo("test"));
        assertThat(with.operation, equalTo("testOperation"));
    }
    ...
    {
        OpenapiWithConfig with = new OpenapiWithConfig("test", "testOperation", null);
