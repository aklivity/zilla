...
public class OpenapiWithConfigAdapter implements WithConfigAdapterSpi, JsonbAdapter<WithConfig, JsonObject>
{
    ...
    public JsonObject adaptToJson(
        WithConfig with)
    {
        OpenapiWithConfig config = (OpenapiWithConfig) with;
        ...
        JsonObject object)
    {
        ...
        return new OpenapiWithConfig(spec, operation, tag);
    }
}
