...
public final class OpenapiServerFactory implements OpenapiStreamFactory
{
    ...
    private final class CompositeStream
    {
        ...
        {
            this.delegate =
                new OpenapiStream(this, routedId, resolvedId, authorization, specId, operationId, binding, server);
            this.sender = sender;
    ...
    private final class OpenapiStream
    {
            ...
            OctetsFW extension)
        {
            if (!OpenapiState.initialOpening(state))
            {
                ...
                final OpenapiBeginExFW openapiBeginEx = binding.resolve(httpBeginEx, openapiBeginExBuilder, server);
