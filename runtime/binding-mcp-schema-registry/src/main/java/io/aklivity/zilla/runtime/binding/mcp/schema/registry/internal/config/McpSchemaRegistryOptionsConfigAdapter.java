...
public final class McpSchemaRegistryOptionsConfigAdapter implements OptionsConfigAdapterSpi,
    JsonbAdapter<OptionsConfig, JsonObject>
{
    @Override
    public Kind kind()
    {
    ...
    public OptionsConfig adaptFromJson(
        JsonObject object)
    {
        return new McpSchemaRegistryOptionsConfig();
    }
}
