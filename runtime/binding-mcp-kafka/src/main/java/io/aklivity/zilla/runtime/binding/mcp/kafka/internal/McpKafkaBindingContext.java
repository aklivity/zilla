...
final class McpKafkaBindingContext implements BindingContext
{
    private final Map<KindConfig, McpKafkaProxyFactory> factories;

    McpKafkaBindingContext(
    ...
    {
        final McpKafkaProxyFactory factory = factories.get(binding.kind);
