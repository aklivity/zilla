# Zilla runtime — Claude Code Guide
...
the root [CLAUDE.md](../CLAUDE.md). Engine-specific conventions live in
[engine/CLAUDE.md](engine/CLAUDE.md). Spec/IT conventions live in
[../specs/CLAUDE.md](../specs/CLAUDE.md).
...
headers) live in the root [CLAUDE.md](../CLAUDE.md). Once the module skeleton
...
project — see [../specs/CLAUDE.md](../specs/CLAUDE.md).
...
described in [../specs/CLAUDE.md](../specs/CLAUDE.md).
