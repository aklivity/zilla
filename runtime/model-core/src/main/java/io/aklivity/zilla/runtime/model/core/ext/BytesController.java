...
/**
 * The per-edge control handle a {@code bytes} pipeline stage uses to steer its immediate upstream.
 * <p>
 * A mediating {@link BytesTransform} supplies its own {@code BytesController} to its downstream; a
...
public interface BytesController
{
    ...
    /**
     * Reports {@code sourceBytes} bytes of the current {@link BytesEvent#SEGMENT} consumed by a bounded
