...
/**
 * The consume end of a {@code bytes} pipeline. Each
 * {@link #transform(BytesController, BytesSource, BytesEvent)} delivers one event, with {@code source}
 ...
 * downstream of a {@link BytesTransform} is also a {@code BytesSink}, so stages compose without knowing
