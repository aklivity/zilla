...
/**
 * One installed bytes model extension, created once per {@link io.aklivity.zilla.runtime.engine.Configuration}
 * by its {@link BytesModelExtFactorySpi}. {@link #supply(EngineContext)} is called once per engine worker,
...
public interface BytesModelExt
{
     ...
     * @return the per-worker {@link BytesModelExtContext}
     */
    BytesModelExtContext supply(
