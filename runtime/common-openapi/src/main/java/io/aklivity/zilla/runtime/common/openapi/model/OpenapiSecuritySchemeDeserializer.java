...
public final class OpenapiSecuritySchemeDeserializer implements JsonbDeserializer<OpenapiSecurityScheme>
{
    ...
    {
        this.extensionTypes = extensionTypes.getOrDefault(OpenapiExtensionScope.SECURITY_SCHEME, emptyMap());
        this.prefixExtensionTypes = prefixExtensionTypes.getOrDefault(OpenapiExtensionScope.SECURITY_SCHEME, emptyMap());
