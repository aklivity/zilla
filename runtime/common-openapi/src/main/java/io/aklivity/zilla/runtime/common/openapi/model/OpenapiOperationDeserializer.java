...
public final class OpenapiOperationDeserializer implements JsonbDeserializer<OpenapiOperation>
{
    ...
    {
        this.extensionTypes = extensionTypes.getOrDefault(OpenapiExtensionScope.OPERATION, emptyMap());
        this.prefixExtensionTypes = prefixExtensionTypes.getOrDefault(OpenapiExtensionScope.OPERATION, emptyMap());
