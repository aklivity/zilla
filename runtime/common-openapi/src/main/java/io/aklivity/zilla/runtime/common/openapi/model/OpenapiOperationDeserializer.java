...
public final class OpenapiOperationDeserializer implements JsonbDeserializer<OpenapiOperation>
{
    ...
    {
        this.extensionTypes = extensionTypes.getOrDefault(OpenapiExtension.Scope.OPERATION, emptyMap());
        this.prefixExtensionTypes = prefixExtensionTypes.getOrDefault(OpenapiExtension.Scope.OPERATION, emptyMap());
