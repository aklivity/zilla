...
public final class OpenapiResponseDeserializer implements JsonbDeserializer<OpenapiResponse>
{
    ...
    {
        this.extensionTypes = extensionTypes.getOrDefault(OpenapiExtension.Scope.RESPONSE, emptyMap());
        this.prefixExtensionTypes = prefixExtensionTypes.getOrDefault(OpenapiExtension.Scope.RESPONSE, emptyMap());
