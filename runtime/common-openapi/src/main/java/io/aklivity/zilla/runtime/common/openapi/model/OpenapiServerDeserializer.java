...
public final class OpenapiServerDeserializer implements JsonbDeserializer<OpenapiServer>
{
    ...
    {
        this.extensionTypes = extensionTypes.getOrDefault(OpenapiExtension.Scope.SERVER, emptyMap());
        this.prefixExtensionTypes = prefixExtensionTypes.getOrDefault(OpenapiExtension.Scope.SERVER, emptyMap());
        this.plain = OpenapiDeserializers.plain(extensionTypes, prefixExtensionTypes, OpenapiServerDeserializer.class);
    }

    @Override
    public OpenapiServer deserialize(
        JsonParser parser,
