...
public final class OpenapiServerDeserializer implements JsonbDeserializer<OpenapiServer>
{
    ...
    {
        this.extensionTypes = extensionTypes.getOrDefault(OpenapiExtensionScope.SERVER, emptyMap());
        this.prefixExtensionTypes = prefixExtensionTypes.getOrDefault(OpenapiExtensionScope.SERVER, emptyMap());
