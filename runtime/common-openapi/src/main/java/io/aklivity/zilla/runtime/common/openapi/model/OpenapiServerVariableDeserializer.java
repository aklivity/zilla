...
public final class OpenapiServerVariableDeserializer implements JsonbDeserializer<OpenapiServerVariable>
{
    ...
    {
        this.extensionTypes = extensionTypes.getOrDefault(OpenapiExtension.Scope.SERVER_VARIABLE, emptyMap());
        this.prefixExtensionTypes = prefixExtensionTypes.getOrDefault(OpenapiExtension.Scope.SERVER_VARIABLE, emptyMap());
        this.plain = OpenapiDeserializers.plain(extensionTypes, prefixExtensionTypes, OpenapiServerVariableDeserializer.class);
    }

    @Override
    public OpenapiServerVariable deserialize(
        JsonParser parser,
