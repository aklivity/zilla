...
public final class OpenapiServerVariableDeserializer implements JsonbDeserializer<OpenapiServerVariable>
{
    ...
    {
        this.extensionTypes = extensionTypes.getOrDefault(OpenapiExtensionScope.SERVER_VARIABLE, emptyMap());
        this.prefixExtensionTypes = prefixExtensionTypes.getOrDefault(OpenapiExtensionScope.SERVER_VARIABLE, emptyMap());
