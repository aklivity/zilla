...
public final class OpenapiRequestBodyDeserializer implements JsonbDeserializer<OpenapiRequestBody>
{
    ...
    {
        this.extensionTypes = extensionTypes.getOrDefault(OpenapiExtension.Scope.REQUEST_BODY, emptyMap());
        this.prefixExtensionTypes = prefixExtensionTypes.getOrDefault(OpenapiExtension.Scope.REQUEST_BODY, emptyMap());
