...
public final class OpenapiRequestBodyDeserializer implements JsonbDeserializer<OpenapiRequestBody>
{
    ...
    {
        this.extensionTypes = extensionTypes.getOrDefault(OpenapiExtensionScope.REQUEST_BODY, emptyMap());
        this.prefixExtensionTypes = prefixExtensionTypes.getOrDefault(OpenapiExtensionScope.REQUEST_BODY, emptyMap());
