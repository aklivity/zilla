...
public class TimestampIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/specs/cog/sse/streams/network/timestamp")
        .addScriptRoot("app", "io/aklivity/zilla/specs/cog/sse/streams/application/data")
        .addScriptRoot("appType", "io/aklivity/zilla/specs/cog/sse/streams/application/type");
