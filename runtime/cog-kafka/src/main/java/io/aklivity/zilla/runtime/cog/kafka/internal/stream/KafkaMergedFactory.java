...
import static io.aklivity.zilla.runtime.cog.kafka.internal.types.KafkaCapabilities.FETCH_ONLY;
import static io.aklivity.zilla.runtime.cog.kafka.internal.types.KafkaCapabilities.PRODUCE_ONLY;
...
import io.aklivity.zilla.runtime.cog.kafka.internal.types.KafkaCapabilities;
import io.aklivity.zilla.runtime.cog.kafka.internal.types.KafkaConditionFW;
...
import io.aklivity.zilla.runtime.cog.kafka.internal.types.KafkaFilterFW;
import io.aklivity.zilla.runtime.cog.kafka.internal.types.KafkaHeaderFW;
import io.aklivity.zilla.runtime.cog.kafka.internal.types.KafkaHeadersFW;
import io.aklivity.zilla.runtime.cog.kafka.internal.types.KafkaKeyFW;
import io.aklivity.zilla.runtime.cog.kafka.internal.types.KafkaNotFW;
...
import io.aklivity.zilla.runtime.cog.kafka.internal.types.KafkaValueMatchFW;
...
import io.aklivity.zilla.runtime.cog.kafka.internal.types.stream.KafkaMergedBeginExFW;
import io.aklivity.zilla.runtime.cog.kafka.internal.types.stream.KafkaMergedDataExFW;
import io.aklivity.zilla.runtime.cog.kafka.internal.types.stream.KafkaMergedFlushExFW;
