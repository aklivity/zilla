 ...
 */
package io.aklivity.zilla.runtime.common.json.json;
...
import io.aklivity.zilla.runtime.common.json.internal.json.JsonpProvider;
...
public final class Jsonp
{
    ...
    public static JsonProvider provider(
        Map<String, ?> config)
    {
        return new JsonpProvider(config);
    }
    ...
    {
        private static final JsonProvider PROVIDER = new JsonpProvider();
    }
}
