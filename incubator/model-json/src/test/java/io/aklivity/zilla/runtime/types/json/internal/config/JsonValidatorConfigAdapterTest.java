 ...
 */
package io.aklivity.zilla.runtime.types.json.internal.config;
...
public class JsonValidatorConfigAdapterTest
{
    ...
    public void shouldReadJsonValidator()
    {
        ...
        // WHEN
        JsonValidatorConfig config = jsonb.fromJson(json, JsonValidatorConfig.class);
    ...
    public void shouldWriteJsonValidator()
    {
        ...
        String expectedJson =
            "{" +
                ...
                "}" +
            "}";
        JsonValidatorConfig config = JsonValidatorConfig.builder()
            .catalog()
                .name("test0")
                    .schema()
                        .subject("subject1")
