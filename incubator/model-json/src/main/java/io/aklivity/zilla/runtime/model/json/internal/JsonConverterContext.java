...
public class JsonConverterContext implements ConverterContext
{
    private final LongFunction<CatalogHandler> supplyCatalog;

    public JsonConverterContext(EngineContext context)
    {
    ...
    {
        return new JsonReadConverterHandler(JsonConverterConfig.class.cast(config), supplyCatalog);
    }
    ...
    public ConverterHandler supplyWriteHandler(
        ConverterConfig config)
    {
        return new JsonWriteConverterHandler(JsonConverterConfig.class.cast(config), supplyCatalog);
    }
}
