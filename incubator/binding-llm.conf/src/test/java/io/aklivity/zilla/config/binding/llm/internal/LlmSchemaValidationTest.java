...
public class LlmSchemaValidationTest
{
    ...
    @Test
    public void shouldAcceptServerRouteWithDialectAndModelWhen()
    {
        String text =
            """
            name: test
    ...
    @Test
    public void shouldAcceptServerRouteWithoutWhen()
    {
        String text =
            """
            name: test
    ...
    @Test(expected = RuntimeException.class)
    public void shouldRejectServerRouteWhenWithUnknownProperty()
    {
        String text =
            """
            name: test
    ...
    @Test(expected = RuntimeException.class)
    public void shouldRejectServerRouteWhenWithUnregisteredDialect()
    {
        String text =
            """
            name: test
