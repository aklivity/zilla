// Generated from /Users/akramyakubov/workspace/aklivity/zilla/incubator/binding-pgsql/src/main/antlr4/io/aklivity/zilla/runtime/binding/pgsql/parser/PostgreSqlLexer.g4 by ANTLR 4.13.1
...
public class PostgreSqlLexer extends PostgreSqlLexerBase {
	...
	public static final int
		...
		SYMMETRIC=91, TABLE=92, THEN=93, TO=94, TOPIC=95, STREAM=96, TRAILING=97, 
		TRUE_P=98, UNION=99, UNIQUE=100, USER=101, USING=102, VARIADIC=103, WHEN=104, 
		WHERE=105, WINDOW=106, WITH=107, AUTHORIZATION=108, BINARY=109, COLLATION=110, 
		CONCURRENTLY=111, CROSS=112, CURRENT_SCHEMA=113, FREEZE=114, FULL=115, 
		ILIKE=116, INNER_P=117, IS=118, ISNULL=119, JOIN=120, LEFT=121, LIKE=122, 
		NATURAL=123, NOTNULL=124, OUTER_P=125, OVER=126, OVERLAPS=127, RIGHT=128, 
		SIMILAR=129, VERBOSE=130, ABORT_P=131, ABSOLUTE_P=132, ACCESS=133, ACTION=134, 
		ADD_P=135, ADMIN=136, AFTER=137, AGGREGATE=138, ALSO=139, ALTER=140, ALWAYS=141, 
		ASSERTION=142, ASSIGNMENT=143, AT=144, ATTRIBUTE=145, BACKWARD=146, BEFORE=147, 
		BEGIN_P=148, BY=149, CACHE=150, CALLED=151, CASCADE=152, CASCADED=153, 
		CATALOG=154, CHAIN=155, CHARACTERISTICS=156, CHECKPOINT=157, CLASS=158, 
		CLOSE=159, CLUSTER=160, COMMENT=161, COMMENTS=162, COMMIT=163, COMMITTED=164, 
		CONFIGURATION=165, CONNECTION=166, CONSTRAINTS=167, CONTENT_P=168, CONTINUE_P=169, 
		CONVERSION_P=170, COPY=171, COST=172, CSV=173, CURSOR=174, CYCLE=175, 
		DATA_P=176, DATABASE=177, DAY_P=178, DEALLOCATE=179, DECLARE=180, DEFAULTS=181, 
		DEFERRED=182, DEFINER=183, DELETE_P=184, DELIMITER=185, DELIMITERS=186, 
		DICTIONARY=187, DISABLE_P=188, DISCARD=189, DOCUMENT_P=190, DOMAIN_P=191, 
		DOUBLE_P=192, DROP=193, EACH=194, ENABLE_P=195, ENCODING=196, ENCRYPTED=197, 
		ENUM_P=198, ESCAPE=199, EVENT=200, EXCLUDE=201, EXCLUDING=202, EXCLUSIVE=203, 
		EXECUTE=204, EXPLAIN=205, EXTENSION=206, EXTERNAL=207, FAMILY=208, FIRST_P=209, 
		FOLLOWING=210, FORCE=211, FORWARD=212, FUNCTION=213, FUNCTIONS=214, GLOBAL=215, 
		GRANTED=216, HANDLER=217, HEADER_P=218, HOLD=219, HOUR_P=220, IDENTITY_P=221, 
		IF_P=222, IMMEDIATE=223, IMMUTABLE=224, IMPLICIT_P=225, INCLUDING=226, 
		INCREMENT=227, INDEX=228, INDEXES=229, INHERIT=230, INHERITS=231, INLINE_P=232, 
		INSENSITIVE=233, INSERT=234, INSTEAD=235, INVOKER=236, ISOLATION=237, 
		...
		WARNING=518, EXCEPTION=519, ASSERT=520, LOOP=521, OPEN=522, ABS=523, CBRT=524, 
		CEIL=525, CEILING=526, DEGREES=527, DIV=528, EXP=529, FACTORIAL=530, FLOOR=531, 
		GCD=532, LCM=533, LN=534, LOG10=535, MIN_SCALE=536, MOD=537, PI=538, POWER=539, 
		RADIANS=540, ROUND=541, SCALE=542, SIGN=543, SQRT=544, TRIM_SCALE=545, 
		TRUNC=546, WIDTH_BUCKET=547, RANDOM=548, SETSEED=549, ACOS=550, ACOSD=551, 
		ASIN=552, ASIND=553, ATAN=554, ATAND=555, ATAN2=556, ATAN2D=557, COS=558, 
		COSD=559, COT=560, COTD=561, SIN=562, SIND=563, TAN=564, TAND=565, SINH=566, 
		COSH=567, TANH=568, ASINH=569, ACOSH=570, ATANH=571, BIT_LENGTH=572, CHAR_LENGTH=573, 
		CHARACTER_LENGTH=574, LOWER=575, OCTET_LENGTH=576, UPPER=577, ASCII=578, 
		BTRIM=579, CHR=580, CONCAT=581, CONCAT_WS=582, FORMAT=583, INITCAP=584, 
		LENGTH=585, LPAD=586, LTRIM=587, MD5=588, PARSE_IDENT=589, PG_CLIENT_ENCODING=590, 
		QUOTE_IDENT=591, QUOTE_LITERAL=592, QUOTE_NULLABLE=593, REGEXP_COUNT=594, 
		REGEXP_INSTR=595, REGEXP_LIKE=596, REGEXP_MATCH=597, REGEXP_MATCHES=598, 
		REGEXP_REPLACE=599, REGEXP_SPLIT_TO_ARRAY=600, REGEXP_SPLIT_TO_TABLE=601, 
		REGEXP_SUBSTR=602, REPEAT=603, RPAD=604, RTRIM=605, SPLIT_PART=606, STARTS_WITH=607, 
		STRING_TO_ARRAY=608, STRING_TO_TABLE=609, STRPOS=610, SUBSTR=611, TO_ASCII=612, 
		TO_HEX=613, TRANSLATE=614, UNISTR=615, AGE=616, CLOCK_TIMESTAMP=617, DATE_BIN=618, 
		DATE_PART=619, DATE_TRUNC=620, ISFINITE=621, JUSTIFY_DAYS=622, JUSTIFY_HOURS=623, 
		JUSTIFY_INTERVAL=624, MAKE_DATE=625, MAKE_INTERVAL=626, MAKE_TIME=627, 
		MAKE_TIMESTAMP=628, MAKE_TIMESTAMPTZ=629, NOW=630, STATEMENT_TIMESTAMP=631, 
		TIMEOFDAY=632, TRANSACTION_TIMESTAMP=633, TO_TIMESTAMP=634, TO_CHAR=635, 
		TO_DATE=636, TO_NUMBER=637, Identifier=638, QuotedIdentifier=639, UnterminatedQuotedIdentifier=640, 
		InvalidQuotedIdentifier=641, InvalidUnterminatedQuotedIdentifier=642, 
		UnicodeQuotedIdentifier=643, UnterminatedUnicodeQuotedIdentifier=644, 
		InvalidUnicodeQuotedIdentifier=645, InvalidUnterminatedUnicodeQuotedIdentifier=646, 
		StringConstant=647, UnterminatedStringConstant=648, UnicodeEscapeStringConstant=649, 
		UnterminatedUnicodeEscapeStringConstant=650, BeginDollarStringConstant=651, 
		BinaryStringConstant=652, UnterminatedBinaryStringConstant=653, InvalidBinaryStringConstant=654, 
		InvalidUnterminatedBinaryStringConstant=655, HexadecimalStringConstant=656, 
		UnterminatedHexadecimalStringConstant=657, InvalidHexadecimalStringConstant=658, 
		InvalidUnterminatedHexadecimalStringConstant=659, Integral=660, NumericFail=661, 
		Numeric=662, PLSQLVARIABLENAME=663, PLSQLIDENTIFIER=664, Whitespace=665, 
		Newline=666, LineComment=667, BlockComment=668, UnterminatedBlockComment=669, 
		MetaCommand=670, EndMetaCommand=671, ErrorCharacter=672, EscapeStringConstant=673, 
		UnterminatedEscapeStringConstant=674, InvalidEscapeStringConstant=675, 
		InvalidUnterminatedEscapeStringConstant=676, AfterEscapeStringConstantMode_NotContinued=677, 
		AfterEscapeStringConstantWithNewlineMode_NotContinued=678, DollarText=679, 
		EndDollarStringConstant=680, AfterEscapeStringConstantWithNewlineMode_Continued=681;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"TOPIC", "STREAM", "TRAILING", "TRUE_P", "UNION", "UNIQUE", "USER", "USING", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'COLLATION'", "'CONCURRENTLY'", "'CROSS'", "'CURRENT_SCHEMA'", "'FREEZE'", 
			"'FULL'", "'ILIKE'", "'INNER'", "'IS'", "'ISNULL'", "'JOIN'", "'LEFT'", 
			"'LIKE'", "'NATURAL'", "'NOTNULL'", "'OUTER'", "'OVER'", "'OVERLAPS'", 
	...
	private static final String _serializedATNSegment0 =
		...
		"3\u0001\u000009\u0002\u0000++--\t\u0000!!##%&**<@^^``||~~\u0002\u0000"+
		"*+<>\b\u0000!!##%&?@^^``||~~\u0002\u0000AAaa\u0002\u0000LLll\u0002\u0000"+
		"NNnn\u0002\u0000YYyy\u0002\u0000SSss\u0002\u0000EEee\u0002\u0000ZZzz\u0002"+
		"\u0000DDdd\u0002\u0000RRrr\u0002\u0000CCcc\u0002\u0000MMmm\u0002\u0000"+
		"TTtt\u0002\u0000IIii\u0002\u0000BBbb\u0002\u0000OOoo\u0002\u0000HHhh\u0002"+
		"\u0000KKkk\u0002\u0000UUuu\u0002\u0000GGgg\u0002\u0000PPpp\u0002\u0000"+
		"FFff\u0002\u0000XXxx\u0002\u0000VVvv\u0002\u0000QQqq\u0002\u0000WWww\u0002"+
		"\u0000JJjj\t\u0000AZ__az\u00aa\u00aa\u00b5\u00b5\u00ba\u00ba\u00c0\u00d6"+
		"\u00d8\u00f6\u00f8\u00ff\u0002\u0000\u0100\u8000\ud7ff\u8000\ue000\u8000"+
		"\uffff\u0001\u0000\u8000\ud800\u8000\udbff\u0001\u0000\u8000\udc00\u8000"+
		"\udfff\u0002\u0000\u0000\u0000\"\"\u0001\u0000\"\"\u0001\u0000\'\'\u0001"+
