...
@Incubating
public class ZillaInspectCommandSpi implements ZillaCommandSpi
{
    @Override
    public void mixin(
        CliBuilder<Runnable> builder)
    {
        builder.withGroup("inspect")
            .withDescription("Inspect zilla internals")
            .withCommand(ZillaInspectSchemaCommand.class);
    }
}
