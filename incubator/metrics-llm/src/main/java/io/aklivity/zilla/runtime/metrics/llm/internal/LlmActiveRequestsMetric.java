...
public final class LlmActiveRequestsMetric implements Metric
{
    static final String NAME = String.format("%s.%s", LlmMetricGroup.NAME, "active.requests");

    private static final String GROUP = LlmMetricGroup.NAME;
    private static final String DESCRIPTION = "Number of active LLM requests";
