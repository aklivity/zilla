...
public final class LlmDurationMetric implements Metric
{
    static final String NAME = String.format("%s.%s", LlmMetricGroup.NAME, "duration");

    private static final String GROUP = LlmMetricGroup.NAME;
    private static final String DESCRIPTION = "Duration of LLM exchanges";
