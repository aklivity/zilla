...
public class GrpcRequestSizeMetric implements Metric
{
    ...
    private static final String DESCRIPTION = "gRPC request content length";
    ...
    {
        return new GrpcSizeMetricContext(GROUP, kind(), RECEIVED);
    }
}
