...
public class GrpcResponseSizeMetric implements Metric
{
    ...
    private static final String DESCRIPTION = "gRPC response content length";
    ...
    {
        return new GrpcSizeMetricContext(GROUP, kind(), SENT);
    }
}
