 ...
 */
package io.aklivity.zilla.runtime.converter.avro.config;
...
public final class AvroConverterConfig extends ConverterConfig
{
    ...
    public static <T> AvroConverterConfigBuilder<T> builder(
        Function<ConverterConfig, T> mapper)
    {
        return new AvroConverterConfigBuilder<>(mapper::apply);
    }

    public static AvroConverterConfigBuilder<AvroConverterConfig> builder()
    {
