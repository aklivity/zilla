 ...
 */
package io.aklivity.zilla.specs.converter.avro.config;
...
public class SchemaTest
{
    ...
    public final ConfigSchemaRule schema = new ConfigSchemaRule()
        ...
        .schemaPatch("io/aklivity/zilla/specs/converter/avro/schema/avro.schema.patch.json")
        .configurationRoot("io/aklivity/zilla/specs/converter/avro/config");
