 ...
 */
package io.aklivity.zilla.specs.converter.json.config;
...
public class SchemaTest
{
    ...
    public final ConfigSchemaRule schema = new ConfigSchemaRule()
        ...
        .schemaPatch("io/aklivity/zilla/specs/converter/json/schema/json.schema.patch.json")
        .configurationRoot("io/aklivity/zilla/specs/converter/json/config");
