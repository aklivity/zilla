 ...
 */
package io.aklivity.zilla.config.binding.risingwave;
...
public enum RisingwaveCommandType
{
    ...
    SHOW_TABLES_COMMAND("SHOW TABLES".getBytes()),
    SHOW_MATERIALIZED_VIEWS_COMMAND("SHOW MATERIALIZED VIEWS".getBytes()),
