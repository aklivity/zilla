...
public final class StreamClosesMetricContext implements MetricContext
{
    private final String group;
    private final Metric.Kind kind;
    private final Direction direction;

    public StreamClosesMetricContext(
        String group,
        Metric.Kind kind,
        Direction direction)
    {
    ...
    {
        return new StreamClosesHandler(recorder);
    }

    private final class StreamClosesHandler implements MessageConsumer
    {
        private final LongConsumer recorder;

        private StreamClosesHandler(
            LongConsumer recorder)
        {
