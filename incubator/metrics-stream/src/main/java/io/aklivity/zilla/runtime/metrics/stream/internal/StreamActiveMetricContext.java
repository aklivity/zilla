...
public final class StreamActiveMetricContext implements MetricContext
{
    private final String group;
    private final Metric.Kind kind;
    private final Direction direction;

    public StreamActiveMetricContext(
        String group,
        Metric.Kind kind,
        Direction direction)
    {
    ...
    private final class StreamActiveHandler implements MessageConsumer
    {
        private final LongConsumer recorder;

        private StreamActiveHandler(
            LongConsumer recorder)
        {
