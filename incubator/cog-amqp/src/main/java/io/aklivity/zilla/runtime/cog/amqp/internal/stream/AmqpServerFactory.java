...
import static io.aklivity.zilla.runtime.cog.amqp.internal.AmqpConfiguration.AMQP_INCOMING_LOCALES_DEFAULT;
...
import static io.aklivity.zilla.runtime.cog.amqp.internal.stream.AmqpSessionState.END_RCVD;
import static io.aklivity.zilla.runtime.cog.amqp.internal.stream.AmqpSessionState.MAPPED;
import static io.aklivity.zilla.runtime.cog.amqp.internal.stream.AmqpSessionState.UNMAPPED;
import static io.aklivity.zilla.runtime.cog.amqp.internal.stream.AmqpTransferFlags.aborted;
import static io.aklivity.zilla.runtime.cog.amqp.internal.stream.AmqpTransferFlags.batchable;
import static io.aklivity.zilla.runtime.cog.amqp.internal.stream.AmqpTransferFlags.isSettled;
import static io.aklivity.zilla.runtime.cog.amqp.internal.stream.AmqpTransferFlags.resume;
import static io.aklivity.zilla.runtime.cog.amqp.internal.stream.AmqpTransferFlags.settled;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.AmqpAnnotationKeyFW.KIND_ID;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.AmqpAnnotationKeyFW.KIND_NAME;
...
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpBeginFW.DEFAULT_VALUE_HANDLE_MAX;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpDescribedType.APPLICATION_PROPERTIES;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpDescribedType.DATA;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpDescribedType.MESSAGE_ANNOTATIONS;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpDescribedType.PROPERTIES;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpDescribedType.SASL_INIT;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpDescribedType.SEQUENCE;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpDescribedType.VALUE;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.CONNECTION_FRAMING_ERROR;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.DECODE_ERROR;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.ILLEGAL_STATE;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.INVALID_FIELD;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.LINK_DETACH_FORCED;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.LINK_MESSAGE_SIZE_EXCEEDED;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.LINK_TRANSFER_LIMIT_EXCEEDED;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.NOT_ALLOWED;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.PRECONDITION_FAILED;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.RESOURCE_LIMIT_EXCEEDED;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.SESSION_ERRANT_LINK;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.SESSION_HANDLE_IN_USE;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.SESSION_UNATTACHED_HANDLE;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType.SESSION_WINDOW_VIOLATION;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpOpenFW.DEFAULT_VALUE_MAX_FRAME_SIZE;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpPerformativeType.ATTACH;
...
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpPerformativeType.TRANSFER;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpReceiverSettleMode.FIRST;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpRole.RECEIVER;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpRole.SENDER;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSaslCode.OK;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSenderSettleMode.MIXED;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpType.BINARY1;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpType.BINARY4;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpType.STRING1;
import static io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpType.STRING4;
...
import io.aklivity.zilla.runtime.cog.amqp.internal.types.AmqpBodyKind;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.AmqpCapabilities;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.AmqpPropertiesFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.Array32FW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.Array8FW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.BoundedOctetsFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.Flyweight;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.OctetsFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.String8FW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.StringFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpApplicationPropertiesFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpAttachFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpBeginFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpBinaryFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpCloseFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpDescribedType;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpDescribedTypeFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpDetachFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpEndFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorListFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpErrorType;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpFlowFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpFrameHeaderFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpHeaderFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpIETFLanguageTagFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpMapFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpMessagePropertiesFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpOpenFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpPerformativeType;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpPerformativeTypeFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpProtocolHeaderFW;
...
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSaslFrameHeaderFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSaslInitFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSaslMechanismsFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSaslOutcomeFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSectionType;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSectionTypeFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSecurityFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSenderSettleMode;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSimpleTypeFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSourceFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSourceListFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpStringFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpSymbolFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpTargetFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpTargetListFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpTransferFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpType;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpULongFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpValueFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpVariableLength32FW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.codec.AmqpVariableLength8FW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.stream.AbortFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.stream.AmqpBeginExFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.stream.AmqpDataExFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.stream.BeginFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.stream.DataFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.stream.EndFW;
import io.aklivity.zilla.runtime.cog.amqp.internal.types.stream.FlushFW;
