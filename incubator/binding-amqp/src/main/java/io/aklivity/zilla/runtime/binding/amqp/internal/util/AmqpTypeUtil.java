 ...
 * under the License.
 */
package io.aklivity.zilla.runtime.binding.amqp.internal.util;
...
public final class AmqpTypeUtil
{
    ...
    public static io.aklivity.zilla.runtime.binding.amqp.internal.types.AmqpSenderSettleMode amqpSenderSettleMode(
        AmqpSenderSettleMode senderSettleMode)
    {
        switch (senderSettleMode)
        {
        case UNSETTLED:
            return io.aklivity.zilla.runtime.binding.amqp.internal.types.AmqpSenderSettleMode.UNSETTLED;
        case SETTLED:
            return io.aklivity.zilla.runtime.binding.amqp.internal.types.AmqpSenderSettleMode.SETTLED;
        case MIXED:
            return io.aklivity.zilla.runtime.binding.amqp.internal.types.AmqpSenderSettleMode.MIXED;
        default:
            throw new IllegalArgumentException("Illegal senderSettleMode: " + senderSettleMode);
        }
    }

    public static io.aklivity.zilla.runtime.binding.amqp.internal.types.AmqpReceiverSettleMode amqpReceiverSettleMode(
        AmqpReceiverSettleMode receiverSettleMode)
    {
        switch (receiverSettleMode)
        {
        case FIRST:
            return io.aklivity.zilla.runtime.binding.amqp.internal.types.AmqpReceiverSettleMode.FIRST;
        case SECOND:
            return io.aklivity.zilla.runtime.binding.amqp.internal.types.AmqpReceiverSettleMode.SECOND;
        default:
    ...
    public static AmqpSenderSettleMode amqpSenderSettleMode(
        io.aklivity.zilla.runtime.binding.amqp.internal.types.AmqpSenderSettleMode senderSettleMode)
    {
        switch (senderSettleMode)
        {
        case UNSETTLED:
    ...
    public static AmqpReceiverSettleMode amqpReceiverSettleMode(
        io.aklivity.zilla.runtime.binding.amqp.internal.types.AmqpReceiverSettleMode receiverSettleMode)
    {
        switch (receiverSettleMode)
        {
        case FIRST:
