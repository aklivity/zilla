...
import static io.aklivity.zilla.runtime.binding.amqp.internal.AmqpConfiguration.AMQP_CHANNEL_MAX;
...
import static io.aklivity.zilla.runtime.binding.amqp.internal.AmqpConfiguration.AMQP_HANDLE_MAX;
import static io.aklivity.zilla.runtime.binding.amqp.internal.AmqpConfiguration.AMQP_IDLE_TIMEOUT;
import static io.aklivity.zilla.runtime.binding.amqp.internal.AmqpConfiguration.AMQP_INCOMING_LOCALES;
import static io.aklivity.zilla.runtime.binding.amqp.internal.AmqpConfiguration.AMQP_INITIAL_DEVIVERY_COUNT;
import static io.aklivity.zilla.runtime.binding.amqp.internal.AmqpConfiguration.AMQP_MAX_FRAME_SIZE;
import static io.aklivity.zilla.runtime.binding.amqp.internal.AmqpConfiguration.AMQP_MAX_MESSAGE_SIZE;
import static io.aklivity.zilla.runtime.binding.amqp.internal.AmqpConfiguration.AMQP_OUTGOING_WINDOW;
