...
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.CLOSE_PIPE;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.CLOSE_RCVD;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.CLOSE_SENT;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.DISCARDING;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.END;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.ERROR;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.HDR_EXCH;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.HDR_RCVD;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.HDR_SENT;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.OC_PIPE;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.OPENED;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.OPEN_PIPE;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.OPEN_RCVD;
import static io.aklivity.zilla.runtime.binding.amqp.internal.stream.AmqpConnectionState.OPEN_SENT;
