...
public class VectorModelIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/specs/model/vector/streams/network")
        .addScriptRoot("app", "io/aklivity/zilla/specs/model/vector/streams/application");
    ...
    private final EngineRule engine = new EngineRule()
        ...
        .configurationRoot("io/aklivity/zilla/specs/model/vector/config")
        .external("app0")
        .clean();
