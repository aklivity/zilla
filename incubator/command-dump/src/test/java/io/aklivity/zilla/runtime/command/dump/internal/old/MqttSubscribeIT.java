...
//
//public class MqttSubscribeIT
//{
//    private static final String SUBSCRIPTION_ID_NAME = "zilla.binding.mqtt.subscription.id";
//
//    private final K3poRule k3po = new K3poRule()
//        .addScriptRoot("net", "io/aklivity/zilla/specs/command/dump/binding/mqtt/streams/network/v5")
//        .addScriptRoot("app", "io/aklivity/zilla/specs/command/dump/binding/mqtt/streams/application");
//
...
//            "io.aklivity.zilla.runtime.command.dump.internal.old.MqttSubscribeIT::supplySubscriptionId")
//        .configure(ENGINE_TIMESTAMPS, false)
//        .configurationRoot("io/aklivity/zilla/specs/command/dump/binding/mqtt/config")
//        .external("app0")
//        .external("app1")
//        .clean();
//
