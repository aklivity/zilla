...
public class FileSystemServerIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("app", "io/aklivity/zilla/specs/command/dump/binding/filesystem/streams/application");
    ...
    private final EngineRule engine = new EngineRule()
        ...
        .configurationRoot("io/aklivity/zilla/specs/command/dump/binding/filesystem/config")
        .external("app0")
        .clean();
