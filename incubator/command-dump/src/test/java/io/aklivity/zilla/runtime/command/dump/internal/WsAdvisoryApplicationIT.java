...
public class WsAdvisoryApplicationIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("app", "io/aklivity/zilla/runtime/command/dump/binding/ws/streams/application/advise");

    private final TestRule timeout = new DisableOnDebug(new Timeout(5, SECONDS));

    private final DumpRule dump = new DumpRule()
        .labels("test", "app0", "ws", "server")
        .bindings("test.app0", "test.ws", "test.server", "test.0", "test.0");
