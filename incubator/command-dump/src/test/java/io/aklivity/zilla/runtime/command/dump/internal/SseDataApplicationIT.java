...
public class SseDataApplicationIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("app", "io/aklivity/zilla/runtime/command/dump/binding/sse/streams/application/data");

    private final TestRule timeout = new DisableOnDebug(new Timeout(5, SECONDS));

    private final DumpRule dump = new DumpRule()
        .labels("test", "app0", "sse", "server")
        .bindings("test.app0", "test.sse", "test.server", "test.0", "test.0");
