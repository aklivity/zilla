...
public class CustomFramesIT
{
    private static final int STREAMS_CAPACITY = 2 * 1024;
    ...
    @Rule
    public final TestRule chain = outerRule(dump);

    @Test
    public void shouldWriteCustomFrames() throws Exception
    {
        StreamsLayout streamsLayout = new StreamsLayout.Builder()
            .path(ENGINE_PATH.resolve("data63"))
