...
public class GrpcServerStreamRpcNetworkIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/runtime/command/dump/binding/grpc/streams/network/server.stream.rpc");

    private final TestRule timeout = new DisableOnDebug(new Timeout(10, SECONDS));

    private final DumpRule dump = new DumpRule()
        .labels("test", "net0", "http", "grpc", "server")
        .bindings("test.net0", "test.grpc", "test.server", "test.0", "test.grpc");
