...
public class MqttSubscribeNetworkIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/runtime/command/dump/binding/mqtt/streams/network/v5");

    private final TestRule timeout = new DisableOnDebug(new Timeout(5, SECONDS));

    private final DumpRule dump = new DumpRule()
        .labels("test", "net0", "mqtt", "server")
        .bindings("test.net0", "test.mqtt", "test.server", "test.0", "test.mqtt");
