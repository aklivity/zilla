...
public class SseDataNetworkIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/runtime/command/dump/binding/sse/streams/network/data");

    private final TestRule timeout = new DisableOnDebug(new Timeout(10, SECONDS));

    private final DumpRule dump = new DumpRule()
        .labels("test", "net0", "http", "sse", "server")
        .bindings("test.net0", "test.sse", "test.server", "test.0", "test.sse");
