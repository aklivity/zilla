...
public class SseDataIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/specs/command/dump/binding/sse/streams/network/data")
        .addScriptRoot("app", "io/aklivity/zilla/specs/command/dump/binding/sse/streams/application/data");
    ...
    private final EngineRule engine = new EngineRule()
        ...
        .configurationRoot("io/aklivity/zilla/specs/command/dump/binding/sse/config")
        .external("app0")
        .clean();
