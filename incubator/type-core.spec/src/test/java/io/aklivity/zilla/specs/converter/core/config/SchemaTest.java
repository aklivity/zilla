 ...
 */
package io.aklivity.zilla.specs.converter.core.config;
...
public class SchemaTest
{
    ...
    public final ConfigSchemaRule schema = new ConfigSchemaRule()
        ...
        .schemaPatch("io/aklivity/zilla/specs/converter/core/schema/string.schema.patch.json")
        .configurationRoot("io/aklivity/zilla/specs/converter/core/config");
