...
/**
 * Implemented by a decode {@link io.aklivity.zilla.runtime.common.json.JsonTransform} that needs the native
 * source dialect's out-of-band SSE {@code event:} name to decide its decode behavior (e.g. Anthropic's
 ...
 * implements this, as a no-op, so a caller driving either dialect through the same call site needs no
