 ...
 * and {@link LlmContentEncoder} for the same content-type, registered together so a content-type
 ...
 * </p>
 */
public interface LlmContentCodecSpi
{
    /**
     * Returns the content-type this provider decodes and encodes, e.g. {@code "text/event-stream"}.
     *
     ...
     */
    LlmContentDecoder supplyDecoder();
     ...
     */
    LlmContentEncoder supplyEncoder();
}
