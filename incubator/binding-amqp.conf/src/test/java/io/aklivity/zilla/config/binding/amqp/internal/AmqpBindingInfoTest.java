...
public class AmqpBindingInfoTest
{
    private final AmqpBindingInfo info = new AmqpBindingInfo();

    @Test
    public void shouldResolveType()
    {
        assertThat(info.type(), equalTo("amqp"));
    }
    ...
    {
        assertThat(info.condition(), instanceOf(AmqpConditionConfigAdapter.class));
    }
}
