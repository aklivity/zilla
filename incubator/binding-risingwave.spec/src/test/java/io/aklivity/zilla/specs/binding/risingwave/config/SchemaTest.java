 ...
 */
package io.aklivity.zilla.specs.binding.risingwave.config;
...
public class SchemaTest
{
    ...
    @Test
    public void shouldValidateOptionsUdf()
    {
        JsonObject config = schema.validate("proxy.function.yaml");

        assertThat(config, not(nullValue()));
    }

    @Test
    public void shouldValidateOptionsKafka()
    {
