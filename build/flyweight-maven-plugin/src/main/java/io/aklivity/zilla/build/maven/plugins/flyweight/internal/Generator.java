...
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.ast.visit.ScopeVisitor;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.Array16FWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.Array32FWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.Array8FWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.ArrayFWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.BoundedOctets16FlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.BoundedOctets32FlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.BoundedOctets8FlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.BoundedOctetsFlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.FlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.List0FWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.List32FWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.List8FWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.ListFWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.Map16FWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.Map32FWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.Map8FWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.MapFWGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.OctetsFlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.String16FlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.String32FlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.String8FlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.StringFlyweightGenerator;
...
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.VarStringFlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.Varint32FlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.Varint64FlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.Varuint32FlyweightGenerator;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.generate.Varuint32nFlyweightGenerator;
