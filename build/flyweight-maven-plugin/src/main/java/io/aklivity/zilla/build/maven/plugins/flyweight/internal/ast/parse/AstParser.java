...
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.ast.AstListNode.Builder;
...
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightBaseVisitor;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Array_keywordContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Array_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Case_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.DeclaratorContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Default_nullContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Defined_variant_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Defined_variant_member_with_parametric_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Enum_member_with_defaultContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Enum_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Enum_valueContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Int16_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Int24_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Int32_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Int64_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Int8_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Int_literalContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Int_member_with_defaultContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Integer_array_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.KindContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.List_keywordContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.List_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.List_paramsContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.List_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.List_usingContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Map_keywordContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Map_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.MemberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Member_with_parametric_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Non_primitive_member_with_defaultContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Octets_keywordContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Octets_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.OptionByteOrderContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.ScopeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Scoped_nameContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.SpecificationContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.String16_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.String32_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.String8_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.String_literalContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.String_member_with_defaultContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.String_member_with_null_defaultContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.String_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Struct_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Type_idContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Typedef_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Uint16_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Uint24_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Uint32_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Uint64_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Uint8_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Uint_literalContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Uint_member_with_defaultContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Unbounded_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Unbounded_octets_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Union_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Variant_array_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Variant_case_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Variant_case_member_no_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Variant_case_member_without_ofContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Variant_case_valueContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Variant_int_literalContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Variant_list_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Variant_map_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Variant_octets_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Variant_of_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Variant_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Varint32_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Varint64_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Varint_array_memberContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Varstring_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Varuint32_typeContext;
import io.aklivity.zilla.build.maven.plugins.flyweight.internal.parser.FlyweightParser.Varuint32n_typeContext;


public final class AstParser extends FlyweightBaseVisitor<AstNode>
{
    ...
    public final class ListVisitor extends FlyweightBaseVisitor<AstListNode.Builder>
    {
        ...
        public final class ListParamsVisitor extends FlyweightBaseVisitor<AstListNode.Builder>
        {
            private final AstListNode.Builder listBuilder;
    ...
    public final class VariantVisitor extends FlyweightBaseVisitor<AstVariantNode.Builder>
    {
        ...
        public final class VariantKindVisitor extends FlyweightBaseVisitor<AstVariantNode.Builder>
        {
        ...
        public final class VariantCaseVisitor extends FlyweightBaseVisitor<AstVariantCaseNode.Builder>
        {
        ...
        public final class VariantCaseValueVisitor extends FlyweightBaseVisitor<Object>
        {
            @Override
        ...
        public final class VariantListMemberVisitor extends FlyweightBaseVisitor<AstVariantCaseNode.Builder>
        {
            private final AstVariantCaseNode.Builder variantCaseBuilder;
        ...
        public final class VariantArrayMemberVisitor extends FlyweightBaseVisitor<AstVariantCaseNode.Builder>
        {
            private final AstVariantCaseNode.Builder variantCaseBuilder;
        ...
        public final class MapMemberVisitor extends FlyweightBaseVisitor<AstVariantCaseNode.Builder>
        {
            private final AstVariantCaseNode.Builder variantCaseBuilder;
        ...
        public final class OctetsMemberVisitor extends FlyweightBaseVisitor<AstVariantCaseNode.Builder>
        {
            private final AstVariantCaseNode.Builder variantCaseBuilder;
    ...
    public final class EnumVisitor extends FlyweightBaseVisitor<AstEnumNode.Builder>
    {
