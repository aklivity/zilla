...
```bash
$ curl -v http://localhost:8080/items -H "If-None-Match: AQIAAQ=="
...
> GET /items HTTP/1.1
...
```bash
$ curl -v http://localhost:8080/items/5cf7a1d5-3772-49ef-86e7-ba6f2c7d7d07 -H "Prefer: wait=5"
...
...
```bash
$ echo "{\"greeting\":\"Hello, world `date`\"}" | kcat -P -b localhost:9092 -t items-snapshots -k "5cf7a1d5-3772-49ef-86e7-ba6f2c7d7d07" -H "content-type=application/json"
```
...
```bash
$ curl -v http://localhost:8080/items/5cf7a1d5-3772-49ef-86e7-ba6f2c7d7d07 -H "If-None-Match: AQIAAg=="
...
> GET /items/5cf7a1d5-3772-49ef-86e7-ba6f2c7d7d07 HTTP/1.1
...
```bash
$ curl -v http://localhost:8080/items/5cf7a1d5-3772-49ef-86e7-ba6f2c7d7d07 -H "If-None-Match: AQIAAg==" -H "Prefer: wait=5"
...
> GET /items/5cf7a1d5-3772-49ef-86e7-ba6f2c7d7d07 HTTP/1.1
> If-None-Match: AQIAAg==
> Prefer: wait=60
...
```bash
$ curl -v http://localhost:8080/items/5cf7a1d5-3772-49ef-86e7-ba6f2c7d7d07 -H "If-None-Match: AQIAAg==" -H "Prefer: wait=60"
...
> GET /items/5cf7a1d5-3772-49ef-86e7-ba6f2c7d7d07 HTTP/1.1
> If-None-Match: AQIAAg==
> Prefer: wait=60
