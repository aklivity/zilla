...
[Full Changelog](https://github.com/aklivity/zilla/compare/2.1.0...HEAD)
...
- binding-mcp-schema-registry: implement mcp\_schema\_registry · proxy binding [\#1672](https://github.com/aklivity/zilla/issues/1672) ([jfallows](https://github.com/jfallows))
...
- binding-kafka: add LIST\_GROUPS, DESCRIBE\_GROUPS, ALTER\_CONSUMER\_GROUP\_OFFSETS APIs [\#2119](https://github.com/aklivity/zilla/issues/2119) ([jfallows](https://github.com/jfallows))
...
- binding-mcp-kafka: cluster and broker overview \(list\_brokers, describe\_cluster\) [\#2122](https://github.com/aklivity/zilla/issues/2122) ([jfallows](https://github.com/jfallows))
- binding-mcp-kafka: topic metadata \(list\_topics, describe\_topic, cluster\_overview\) [\#2124](https://github.com/aklivity/zilla/issues/2124) ([jfallows](https://github.com/jfallows))
- binding-mcp-kafka: consumer group management \(list\_consumer\_groups, describe\_consumer\_group, reset\_offsets\) [\#2125](https://github.com/aklivity/zilla/issues/2125) ([jfallows](https://github.com/jfallows))
- binding-mcp-kafka: configs \(describe\_configs, alter\_configs\) [\#2126](https://github.com/aklivity/zilla/issues/2126) ([jfallows](https://github.com/jfallows))
- binding-mcp: support resources/subscribe pass-through [\#2220](https://github.com/aklivity/zilla/issues/2220) ([jfallows](https://github.com/jfallows))
...
- binding-mcp-kafka / binding-mcp-schema-registry: add automated tool-schema consistency check \(annotations completeness + shared field naming\) [\#2249](https://github.com/aklivity/zilla/issues/2249) ([jfallows](https://github.com/jfallows))
- mcp bindings: unify route condition naming to singular tool/prompt/resource, with glob + array support where safe [\#2253](https://github.com/aklivity/zilla/issues/2253) ([jfallows](https://github.com/jfallows))
...
- binding-mcp-kafka: rename consume to consume\_messages, declare output schema with partition/offset/timestamp and collision-splitting headers [\#2282](https://github.com/aklivity/zilla/issues/2282) ([jfallows](https://github.com/jfallows))
...
- binding-mcp-kafka: delete\_topics, alter\_configs, reset\_offsets have missing/incorrect tool annotations [\#2247](https://github.com/aklivity/zilla/issues/2247) ([jfallows](https://github.com/jfallows))
- binding-mcp-kafka: reset\_offsets uses `group` where describe\_consumer\_group uses `group_id` [\#2248](https://github.com/aklivity/zilla/issues/2248) ([jfallows](https://github.com/jfallows))
...
- binding-mcp-schema-registry: add kind: proxy variant with operator-declared exit [\#2104](https://github.com/aklivity/zilla/issues/2104) ([jfallows](https://github.com/jfallows))
...
- binding-mcp-openapi: add kind: proxy variant with operator-declared exit [\#2237](https://github.com/aklivity/zilla/issues/2237) ([jfallows](https://github.com/jfallows))
...
- feat\(binding-mcp-kafka\): implement mcp\_kafka proxy binding [\#1714](https://github.com/aklivity/zilla/pull/1714) ([jfallows](https://github.com/jfallows))
...
- binding-mcp-schema-registry: composite mcp\_schema\_registry · client binding [\#2068](https://github.com/aklivity/zilla/pull/2068) ([jfallows](https://github.com/jfallows))
...
- build\(deps\): Bump maven.version from 3.9.6 to 3.9.16 [\#2088](https://github.com/aklivity/zilla/pull/2088) ([dependabot[bot]](https://github.com/apps/dependabot))
...
- build\(deps\): Bump actions/cache from 5 to 6 [\#2106](https://github.com/aklivity/zilla/pull/2106) ([dependabot[bot]](https://github.com/apps/dependabot))
- build\(deps\): Bump lycheeverse/lychee-action from 2.8.0 to 2.9.0 [\#2107](https://github.com/aklivity/zilla/pull/2107) ([dependabot[bot]](https://github.com/apps/dependabot))
...
- build\(deps\): ignore yasson 3.x on support/1.x [\#2170](https://github.com/aklivity/zilla/pull/2170) ([jfallows](https://github.com/jfallows))
- feat\(ci\): add merge-report workflow [\#2180](https://github.com/aklivity/zilla/pull/2180) ([jfallows](https://github.com/jfallows))
- build\(deps\): Bump body-parser from 2.2.2 to 2.3.0 in /examples/mcp.proxy/url-elicit [\#2181](https://github.com/aklivity/zilla/pull/2181) ([dependabot[bot]](https://github.com/apps/dependabot))
- build: update copyright year to 2026 [\#2183](https://github.com/aklivity/zilla/pull/2183) ([jfallows](https://github.com/jfallows))
- fix\(binding-http\): prevent ReDoS in Basic auth format regex [\#2184](https://github.com/aklivity/zilla/pull/2184) ([jfallows](https://github.com/jfallows))
- refactor\(guard\): rename guard-identity to guard-inline, add Guard aliases [\#2195](https://github.com/aklivity/zilla/pull/2195) ([jfallows](https://github.com/jfallows))
- build\(binding-http\): fix stale copyright year in license header [\#2196](https://github.com/aklivity/zilla/pull/2196) ([jfallows](https://github.com/jfallows))
- docs\(examples\): update http.kafka.oneway.oauthbearer to use inline guard [\#2198](https://github.com/aklivity/zilla/pull/2198) ([jfallows](https://github.com/jfallows))
...
- fix\(binding-mcp\): reject malformed initialize params instead of crashing the worker [\#2226](https://github.com/aklivity/zilla/pull/2226) ([jfallows](https://github.com/jfallows))
- feat\(binding-mcp\): add resources/subscribe, resources/unsubscribe pass-through [\#2227](https://github.com/aklivity/zilla/pull/2227) ([jfallows](https://github.com/jfallows))
- binding-mcp-kafka: describe\_configs/alter\_configs tools [\#2228](https://github.com/aklivity/zilla/pull/2228) ([jfallows](https://github.com/jfallows))
- binding-mcp-kafka: add list\_topics, describe\_topic, cluster\_overview tools [\#2229](https://github.com/aklivity/zilla/pull/2229) ([jfallows](https://github.com/jfallows))
- feat\(binding-mcp-kafka\): add list\_brokers/describe\_cluster MCP tools [\#2230](https://github.com/aklivity/zilla/pull/2230) ([jfallows](https://github.com/jfallows))
- binding-mcp-schema-registry: add kind: proxy variant with operator-declared exit [\#2231](https://github.com/aklivity/zilla/pull/2231) ([jfallows](https://github.com/jfallows))
- feat\(binding-kafka,binding-mcp-kafka\): consumer group management \(\#2125, \#2119\) [\#2232](https://github.com/aklivity/zilla/pull/2232) ([jfallows](https://github.com/jfallows))
- fix\(binding-tcp\): enforce per-route exit requirement for kind: server [\#2241](https://github.com/aklivity/zilla/pull/2241) ([jfallows](https://github.com/jfallows))
- binding-mcp-openapi: add kind: proxy variant with operator-declared exit [\#2242](https://github.com/aklivity/zilla/pull/2242) ([jfallows](https://github.com/jfallows))
- binding-mcp-http: add kind: client and require exit for kind: proxy [\#2243](https://github.com/aklivity/zilla/pull/2243) ([jfallows](https://github.com/jfallows))
- refactor\(binding-kafka\): rename remaining api Response classes with Kafka prefix [\#2244](https://github.com/aklivity/zilla/pull/2244) ([jfallows](https://github.com/jfallows))
- fix\(binding-mcp-kafka\): snake\_case create\_topics/delete\_topics tool fields [\#2246](https://github.com/aklivity/zilla/pull/2246) ([jfallows](https://github.com/jfallows))
- fix\(binding-mcp-kafka\): rename reset\_offsets group field to group\_id [\#2250](https://github.com/aklivity/zilla/pull/2250) ([jfallows](https://github.com/jfallows))
- fix\(binding-mcp-kafka\): correct tool annotations for delete\_topics, alter\_configs, reset\_offsets [\#2251](https://github.com/aklivity/zilla/pull/2251) ([jfallows](https://github.com/jfallows))
- binding-mcp-kafka: fix tool annotations/field naming, add tool-schema consistency check [\#2252](https://github.com/aklivity/zilla/pull/2252) ([jfallows](https://github.com/jfallows))
- feat\(binding-mcp\): disambiguate colliding tool titles across toolkits [\#2262](https://github.com/aklivity/zilla/pull/2262) ([jfallows](https://github.com/jfallows))
- fix\(binding-mcp-kafka\): echo partition/offset in reset\_offsets output [\#2264](https://github.com/aklivity/zilla/pull/2264) ([jfallows](https://github.com/jfallows))
- binding-mcp-kafka-connect: new binding exposing Kafka Connect REST API as MCP tools [\#2265](https://github.com/aklivity/zilla/pull/2265) ([jfallows](https://github.com/jfallows))
- binding-mcp-kafka: real per-tool description and title; binding-mcp-schema-registry: real per-tool description [\#2266](https://github.com/aklivity/zilla/pull/2266) ([jfallows](https://github.com/jfallows))
- binding-mcp-kafka: add list\_acls, create\_acls, delete\_acls tools [\#2267](https://github.com/aklivity/zilla/pull/2267) ([jfallows](https://github.com/jfallows))
- binding-mcp-kafka: add describe\_consumer\_group\_lag tool [\#2268](https://github.com/aklivity/zilla/pull/2268) ([jfallows](https://github.com/jfallows))
- refactor\(binding-mcp,binding-mcp-kafka,binding-mcp-openapi,binding-mcp-schema-registry\): unify route condition naming [\#2269](https://github.com/aklivity/zilla/pull/2269) ([jfallows](https://github.com/jfallows))
- fix\(binding-mcp\): fall back to annotations.title for tool title collisions [\#2271](https://github.com/aklivity/zilla/pull/2271) ([jfallows](https://github.com/jfallows))
- fix\(binding-mcp\): use hyphenated type names for mcp-\* bindings [\#2272](https://github.com/aklivity/zilla/pull/2272) ([jfallows](https://github.com/jfallows))
- feat\(binding-mcp\): top-level tool title support, x-zilla-mcp vendor extension [\#2274](https://github.com/aklivity/zilla/pull/2274) ([jfallows](https://github.com/jfallows))
- fix\(engine,binding-mcp-openapi\): fix mcp-kafka-connect hydration bug \(\#2273\) [\#2275](https://github.com/aklivity/zilla/pull/2275) ([jfallows](https://github.com/jfallows))
- feat\(binding-mcp-kafka\): populate tools/list securitySchemes from guarded routes [\#2276](https://github.com/aklivity/zilla/pull/2276) ([jfallows](https://github.com/jfallows))
- feat\(binding-mcp\): support x-zilla-mcp.description, use it for mcp-kafka-connect tool descriptions [\#2277](https://github.com/aklivity/zilla/pull/2277) ([jfallows](https://github.com/jfallows))
- fix\(binding-mcp\): keep session alive while resources/subscribe pushes notifications [\#2278](https://github.com/aklivity/zilla/pull/2278) ([jfallows](https://github.com/jfallows))
- fix\(binding-mcp-kafka\): fix create\_topics schema gaps, drop timeout arg [\#2286](https://github.com/aklivity/zilla/pull/2286) ([jfallows](https://github.com/jfallows))
- fix\(binding-mcp-kafka\): normalize topic/partition field naming across tool schemas [\#2287](https://github.com/aklivity/zilla/pull/2287) ([jfallows](https://github.com/jfallows))
