...
public class X509GuardInfoTest
{
    private final X509GuardInfo info = new X509GuardInfo();

    @Test
    public void shouldResolveType()
    {
        assertThat(info.type(), equalTo("x509"));
    }
    ...
    {
        assertThat(info.options(), instanceOf(X509OptionsConfigAdapter.class));
    }
}
