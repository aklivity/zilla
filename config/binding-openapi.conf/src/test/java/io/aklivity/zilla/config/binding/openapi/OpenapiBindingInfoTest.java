...
public class OpenapiBindingInfoTest
{
    private final OpenapiBindingInfo info = new OpenapiBindingInfo();

    @Test
    public void shouldResolveType()
    {
        assertThat(info.type(), equalTo("openapi"));
    }
    ...
    {
        assertThat(info.options(), instanceOf(OpenapiOptionsConfigAdapter.class));
    }

    @Test
    public void shouldResolveConditionAdapter()
    {
        assertThat(info.condition(), instanceOf(OpenapiConditionConfigAdapter.class));
    }
}
