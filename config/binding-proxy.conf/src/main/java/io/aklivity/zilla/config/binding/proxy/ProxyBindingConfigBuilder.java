...
public final class ProxyBindingConfigBuilder<T> extends BindingConfigBuilder<T, ProxyBindingConfigBuilder<T>>
{
    ...
    {
        super(mapper);
        type(ProxyBindingInfo.TYPE);
    }

    @Override
    @SuppressWarnings("unchecked")
    protected Class<ProxyBindingConfigBuilder<T>> thisType()
    {
        return (Class<ProxyBindingConfigBuilder<T>>) getClass();
    }

    public ProxyOptionsConfigBuilder<ProxyBindingConfigBuilder<T>> options()
    {
        return new ProxyOptionsConfigBuilder<>(this::options);
    }
