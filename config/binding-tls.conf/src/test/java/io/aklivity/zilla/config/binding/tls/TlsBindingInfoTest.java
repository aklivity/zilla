...
public class TlsBindingInfoTest
{
    private final TlsBindingInfo info = new TlsBindingInfo();

    @Test
    public void shouldResolveType()
    {
        assertThat(info.type(), equalTo("tls"));
    }
    ...
    {
        assertThat(info.options(), instanceOf(TlsOptionsConfigAdapter.class));
    }

    @Test
    public void shouldResolveConditionAdapter()
    {
        assertThat(info.condition(), instanceOf(TlsConditionConfigAdapter.class));
    }
}
