...
public final class TlsBindingConfig extends BindingConfig
{
    public static TlsBindingConfigBuilder<TlsBindingConfig> builder()
    {
        return new TlsBindingConfigBuilder<>(TlsBindingConfig.class::cast);
    }

    public static <T> TlsBindingConfigBuilder<T> builder(
        Function<BindingConfig, T> mapper)
    {
        return new TlsBindingConfigBuilder<>(mapper);
    }
