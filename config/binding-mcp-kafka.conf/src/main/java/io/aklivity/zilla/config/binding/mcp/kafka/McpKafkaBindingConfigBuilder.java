...
public final class McpKafkaBindingConfigBuilder<T> extends BindingConfigBuilder<T, McpKafkaBindingConfigBuilder<T>>
{
    ...
    {
        super(mapper);
        type(McpKafkaBindingInfo.TYPE);
    }

    @Override
    @SuppressWarnings("unchecked")
    protected Class<McpKafkaBindingConfigBuilder<T>> thisType()
    {
        return (Class<McpKafkaBindingConfigBuilder<T>>) getClass();
    }

    public McpKafkaOptionsConfigBuilder<McpKafkaBindingConfigBuilder<T>> options()
    {
        return new McpKafkaOptionsConfigBuilder<>(this::options);
    }
    ...
    {
        return new McpKafkaBindingConfig(
