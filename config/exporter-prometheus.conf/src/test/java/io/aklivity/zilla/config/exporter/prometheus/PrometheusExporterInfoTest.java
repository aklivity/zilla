...
public class PrometheusExporterInfoTest
{
    private final PrometheusExporterInfo info = new PrometheusExporterInfo();

    @Test
    public void shouldResolveType()
    {
        assertThat(info.type(), equalTo("prometheus"));
    }
    ...
    {
        assertThat(info.options(), instanceOf(PrometheusOptionsConfigAdapter.class));
    }
}
