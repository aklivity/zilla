...
import io.aklivity.zilla.config.catalog.schema.registry.internal.SchemaRegistryCatalogInfo;
...
public final class SchemaRegistryCatalogConfigBuilder<T>
    extends CatalogConfigBuilder<T, SchemaRegistryCatalogConfigBuilder<T>>
{
    SchemaRegistryCatalogConfigBuilder(
        Function<CatalogConfig, T> mapper)
    {
        super(mapper);
        type(SchemaRegistryCatalogInfo.TYPE);
    }
    ...
    public SchemaRegistryOptionsConfigBuilder<SchemaRegistryCatalogConfigBuilder<T>> options()
    {
        return new SchemaRegistryOptionsConfigBuilder<>(this::options);
    }
