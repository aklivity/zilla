...
public final class HttpAccessControlConfig
{
    ...
    {
        return policy == HttpPolicyConfig.SAME_ORIGIN || isSameOrigin(headers) ? HttpPolicyConfig.SAME_ORIGIN : policy;
    }
    ...
    public boolean allowRequest(
        Map<String, String> headers)
    {
        return policy == HttpPolicyConfig.CROSS_ORIGIN && allowCrossOrigin(headers) ||
    ...
    public boolean exposeHeader(
        String header)
    {
        return policy == HttpPolicyConfig.SAME_ORIGIN ||
                header.charAt(0) != ':' &&
    ...
    {
        return policy == HttpPolicyConfig.CROSS_ORIGIN && allow != null && allow.originExplicit();
    }

    public boolean allowMethodsExplicit()
    {
        return policy == HttpPolicyConfig.CROSS_ORIGIN && allow != null && allow.methodsExplicit();
    }

    public boolean allowHeadersExplicit()
    {
        return policy == HttpPolicyConfig.CROSS_ORIGIN && allow != null && allow.headersExplicit();
    }

    public boolean allowCredentialsExplicit()
    {
        return policy == HttpPolicyConfig.CROSS_ORIGIN && allow != null && allow.credentialsExplicit();
    }

    public boolean exposeHeaders()
    {
        return policy == HttpPolicyConfig.CROSS_ORIGIN;
    }
    ...
    private boolean allowOrigin(
        String origin)
    {
        return policy == HttpPolicyConfig.SAME_ORIGIN || allow == null || allow.origin(origin);
    }

    private boolean allowMethod(
        String method)
    {
        return policy == HttpPolicyConfig.SAME_ORIGIN || allow == null || allow.method(method);
    }

    private boolean allowHeaders(
        String headers)
    {
        return policy == HttpPolicyConfig.SAME_ORIGIN || allow == null || allow.headers(headers);
    }
