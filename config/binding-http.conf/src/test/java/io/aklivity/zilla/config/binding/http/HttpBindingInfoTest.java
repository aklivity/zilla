...
{
    private final HttpBindingInfo info = new HttpBindingInfo();

    @Test
    public void shouldResolveType()
    {
        assertThat(info.type(), equalTo("http"));
    }
    ...
    {
        assertThat(info.options(), instanceOf(HttpOptionsConfigAdapter.class));
    }

    @Test
    public void shouldResolveConditionAdapter()
    {
        assertThat(info.condition(), instanceOf(HttpConditionConfigAdapter.class));
    }
}
