...
import static io.aklivity.zilla.config.model.core.DoubleModelConfig.DOUBLE;
...
public class DoubleModelConfigAdapter extends ConfigAdapter<ModelConfig, JsonValue> implements ModelConfigAdapterSpi
{
