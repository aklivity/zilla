...
import static io.aklivity.zilla.config.model.core.Int64ModelConfig.INT_64;
...
public class Int64ModelConfigAdapter extends ConfigAdapter<ModelConfig, JsonValue>
{
        ...
        ModelConfig options)
    {
        ...
        if (config.format.equals(Int64ModelConfigBuilder.DEFAULT_FORMAT) &&
            ...
            validateJson == null)
        {
            result = Json.createValue(INT_64);
        }
        else
        {
