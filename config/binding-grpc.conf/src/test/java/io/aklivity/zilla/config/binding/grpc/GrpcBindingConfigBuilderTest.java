...
import io.aklivity.zilla.config.binding.grpc.internal.GrpcBindingInfo;
import io.aklivity.zilla.config.engine.ConditionConfig;
import io.aklivity.zilla.config.engine.RouteConfig;

public class GrpcBindingConfigBuilderTest
{
    @Test
    public void shouldBuildBindingViaFluentKindSpecificChain()
    {
        GrpcBindingConfig binding = GrpcBindingConfig.builder()
            .namespace("test")
            .name("grpc0")
            .kind(SERVER)
            .route()
        ...
        assertThat(binding.name, equalTo("grpc0"));
        assertThat(binding.type, equalTo(GrpcBindingInfo.TYPE));
        ...
        assertThat(condition, instanceOf(GrpcConditionConfig.class));
        assertThat(((GrpcConditionConfig) condition).method, equalTo("example.EchoService/Echo"));
    }
}
