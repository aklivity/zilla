...
public final class GrpcBindingConfigBuilder<T> extends BindingConfigBuilder<T, GrpcBindingConfigBuilder<T>>
{
    ...
    {
        super(mapper);
        type(GrpcBindingInfo.TYPE);
    }

    @Override
    @SuppressWarnings("unchecked")
    protected Class<GrpcBindingConfigBuilder<T>> thisType()
    {
        return (Class<GrpcBindingConfigBuilder<T>>) getClass();
    }
