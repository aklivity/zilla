...
public class McpKafkaConnectBindingInfoTest
{
    private final McpKafkaConnectBindingInfo info = new McpKafkaConnectBindingInfo();
    ...
    {
        assertThat(info.options(), instanceOf(McpKafkaConnectOptionsConfigAdapter.class));
    }

    @Test
    public void shouldResolveConditionAdapter()
    {
        assertThat(info.condition(), instanceOf(McpKafkaConnectConditionConfigAdapter.class));
    }
}
