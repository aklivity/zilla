...
public final class McpKafkaConnectBindingInfo implements BindingInfo
{
    ...
    public URL schema()
    {
        return getClass().getResource("schema/mcp_kafka_connect.schema.patch.json");
    }

    @Override
    public JsonbAdapter<OptionsConfig, JsonObject> options()
    {
        return new McpKafkaConnectOptionsConfigAdapter();
    }

    @Override
    public JsonbAdapter<ConditionConfig, JsonObject> condition()
    {
        return new McpKafkaConnectConditionConfigAdapter();
    }
}
