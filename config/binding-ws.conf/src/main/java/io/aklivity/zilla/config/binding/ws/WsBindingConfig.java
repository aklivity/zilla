...
public final class WsBindingConfig extends BindingConfig
{
    public static WsBindingConfigBuilder<WsBindingConfig> builder()
    {
        return new WsBindingConfigBuilder<>(WsBindingConfig.class::cast);
    }

    public static <T> WsBindingConfigBuilder<T> builder(
        Function<BindingConfig, T> mapper)
    {
        return new WsBindingConfigBuilder<>(mapper);
    }
