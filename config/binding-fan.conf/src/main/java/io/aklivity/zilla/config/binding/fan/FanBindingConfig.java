...
public final class FanBindingConfig extends BindingConfig
{
    public static FanBindingConfigBuilder<FanBindingConfig> builder()
    {
        return new FanBindingConfigBuilder<>(FanBindingConfig.class::cast);
    }

    public static <T> FanBindingConfigBuilder<T> builder(
        Function<BindingConfig, T> mapper)
    {
        return new FanBindingConfigBuilder<>(mapper);
    }
