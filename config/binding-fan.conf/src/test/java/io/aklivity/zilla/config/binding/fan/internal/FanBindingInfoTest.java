 ...
 */
package io.aklivity.zilla.config.binding.fan.internal;
...
public class FanBindingInfoTest
{
    private final FanBindingInfo info = new FanBindingInfo();

    @Test
    public void shouldResolveType()
    {
        assertThat(info.type(), equalTo("fan"));
    }
