...
public class SseBindingInfoTest
{
    private final SseBindingInfo info = new SseBindingInfo();

    @Test
    public void shouldResolveType()
    {
        assertThat(info.type(), equalTo("sse"));
    }
    ...
    {
        assertThat(info.options(), instanceOf(SseOptionsConfigAdapter.class));
    }

    @Test
    public void shouldResolveConditionAdapter()
    {
        assertThat(info.condition(), instanceOf(SseConditionConfigAdapter.class));
    }
}
