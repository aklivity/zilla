...
public final class SseBindingConfig extends BindingConfig
{
    public static SseBindingConfigBuilder<SseBindingConfig> builder()
    {
        return new SseBindingConfigBuilder<>(SseBindingConfig.class::cast);
    }

    public static <T> SseBindingConfigBuilder<T> builder(
        Function<BindingConfig, T> mapper)
    {
        return new SseBindingConfigBuilder<>(mapper);
    }
