...
public final class SseBindingConfigBuilder<T> extends BindingConfigBuilder<T, SseBindingConfigBuilder<T>>
{
    ...
    {
        super(mapper);
        type(SseBindingInfo.TYPE);
    }

    @Override
    @SuppressWarnings("unchecked")
    protected Class<SseBindingConfigBuilder<T>> thisType()
    {
        return (Class<SseBindingConfigBuilder<T>>) getClass();
    }

    public SseOptionsConfigBuilder<SseBindingConfigBuilder<T>> options()
    {
        return new SseOptionsConfigBuilder<>(this::options);
    }
