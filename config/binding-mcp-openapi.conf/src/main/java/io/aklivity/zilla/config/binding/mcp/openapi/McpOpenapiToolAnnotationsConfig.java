...
public final class McpOpenapiToolAnnotationsConfig extends Config
{
    ...
    public static McpOpenapiToolAnnotationsConfigBuilder<McpOpenapiToolAnnotationsConfig> builder()
    {
        return new McpOpenapiToolAnnotationsConfigBuilder<>(McpOpenapiToolAnnotationsConfig.class::cast);
    }

    public static <T> McpOpenapiToolAnnotationsConfigBuilder<T> builder(
        Function<McpOpenapiToolAnnotationsConfig, T> mapper)
    {
        return new McpOpenapiToolAnnotationsConfigBuilder<>(mapper);
    }
