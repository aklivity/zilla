...
public final class EngineConfigReader
{
        ...
        String configText)
    {
        ...
        try
        {
            EngineSchemaReader schemaReader = new EngineSchemaReader(info);
            JsonObject schemaObject = schemaReader.stripIncubating(schemaReader.read());

            schemaLogger.accept(EngineSchemaReader.write(schemaObject));
        ...
        String configText)
    {
        ...
        try
        {
            ...
            annotatedSchemaLogger.accept(EngineSchemaReader.write(annotatedSchemaObject));
