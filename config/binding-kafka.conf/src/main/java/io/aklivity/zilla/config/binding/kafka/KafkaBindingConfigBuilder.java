...
public final class KafkaBindingConfigBuilder<T> extends BindingConfigBuilder<T, KafkaBindingConfigBuilder<T>>
{
    ...
    {
        super(mapper);
        type(KafkaBindingInfo.TYPE);
    }

    @Override
    @SuppressWarnings("unchecked")
    protected Class<KafkaBindingConfigBuilder<T>> thisType()
    {
        return (Class<KafkaBindingConfigBuilder<T>>) getClass();
    }

    public KafkaOptionsConfigBuilder<KafkaBindingConfigBuilder<T>> options()
    {
        return new KafkaOptionsConfigBuilder<>(this::options);
    }
