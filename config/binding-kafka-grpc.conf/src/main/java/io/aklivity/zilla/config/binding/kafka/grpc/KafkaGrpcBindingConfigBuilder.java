...
public final class KafkaGrpcBindingConfigBuilder<T> extends BindingConfigBuilder<T, KafkaGrpcBindingConfigBuilder<T>>
{
    ...
    {
        super(mapper);
        type(KafkaGrpcBindingInfo.TYPE);
    }

    @Override
    @SuppressWarnings("unchecked")
    protected Class<KafkaGrpcBindingConfigBuilder<T>> thisType()
    {
        return (Class<KafkaGrpcBindingConfigBuilder<T>>) getClass();
    }

    public KafkaGrpcOptionsConfigBuilder<KafkaGrpcBindingConfigBuilder<T>> options()
    {
        return new KafkaGrpcOptionsConfigBuilder<>(this::options);
    }
    ...
    {
        return new KafkaGrpcBindingConfig(
