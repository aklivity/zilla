...
final class McpAllToolsEagerConfigAdapter extends ConfigAdapter<McpToolsEagerConfig, JsonObject>
{
        ...
        McpToolsEagerConfig options)
    {
        return Json.createObjectBuilder()
            .add(TYPE_NAME, McpAllToolsEagerConfig.NAME)
            .build();
    }
    ...
    public McpToolsEagerConfig adaptFromJson(
        JsonObject object)
    {
        return McpAllToolsEagerConfig.builder().build();
    }
}
