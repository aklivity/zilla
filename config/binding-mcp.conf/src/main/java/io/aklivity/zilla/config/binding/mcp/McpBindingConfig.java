...
public final class McpBindingConfig extends BindingConfig
{
    public static McpBindingConfigBuilder<McpBindingConfig> builder()
    {
        return new McpBindingConfigBuilder<>(McpBindingConfig.class::cast);
    }

    public static <T> McpBindingConfigBuilder<T> builder(
        Function<BindingConfig, T> mapper)
    {
        return new McpBindingConfigBuilder<>(mapper);
    }
