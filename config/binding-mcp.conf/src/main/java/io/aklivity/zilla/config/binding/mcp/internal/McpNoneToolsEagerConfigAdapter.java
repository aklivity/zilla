...
final class McpNoneToolsEagerConfigAdapter extends ConfigAdapter<McpToolsEagerConfig, JsonObject>
{
        ...
        McpToolsEagerConfig options)
    {
        return Json.createObjectBuilder()
            .add(TYPE_NAME, McpNoneToolsEagerConfig.NAME)
            .build();
    }
    ...
    public McpToolsEagerConfig adaptFromJson(
        JsonObject object)
    {
        return McpNoneToolsEagerConfig.builder().build();
    }
}
