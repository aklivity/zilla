...
import static io.aklivity.zilla.engine.drive.cog.budget.BudgetCreditor.NO_BUDGET_ID;
import static io.aklivity.zilla.engine.drive.cog.concurrent.Signaler.NO_CANCEL_ID;
import static io.aklivity.zilla.engine.drive.internal.stream.BudgetId.ownerIndex;
import static io.aklivity.zilla.engine.drive.internal.stream.StreamId.instanceId;
import static io.aklivity.zilla.engine.drive.internal.stream.StreamId.isInitial;
import static io.aklivity.zilla.engine.drive.internal.stream.StreamId.remoteIndex;
import static io.aklivity.zilla.engine.drive.internal.stream.StreamId.streamId;
import static io.aklivity.zilla.engine.drive.internal.stream.StreamId.streamIndex;
import static io.aklivity.zilla.engine.drive.internal.stream.StreamId.throttleIndex;
...
import io.aklivity.zilla.engine.drive.cog.AxleContext;
...
import io.aklivity.zilla.engine.drive.internal.Counters;
import io.aklivity.zilla.engine.drive.internal.LabelManager;
...
import io.aklivity.zilla.engine.drive.internal.layouts.BufferPoolLayout;
import io.aklivity.zilla.engine.drive.internal.layouts.LoadLayout;
import io.aklivity.zilla.engine.drive.internal.layouts.MetricsLayout;
import io.aklivity.zilla.engine.drive.internal.layouts.StreamsLayout;
import io.aklivity.zilla.engine.drive.internal.load.LoadEntry;
import io.aklivity.zilla.engine.drive.internal.load.LoadManager;
import io.aklivity.zilla.engine.drive.internal.poller.Poller;
import io.aklivity.zilla.engine.drive.internal.stream.NamespacedId;
import io.aklivity.zilla.engine.drive.internal.stream.StreamId;
import io.aklivity.zilla.engine.drive.internal.stream.Target;
import io.aklivity.zilla.engine.drive.internal.types.stream.AbortFW;
import io.aklivity.zilla.engine.drive.internal.types.stream.BeginFW;
import io.aklivity.zilla.engine.drive.internal.types.stream.ChallengeFW;
import io.aklivity.zilla.engine.drive.internal.types.stream.DataFW;
import io.aklivity.zilla.engine.drive.internal.types.stream.EndFW;
import io.aklivity.zilla.engine.drive.internal.types.stream.FlushFW;
import io.aklivity.zilla.engine.drive.internal.types.stream.FrameFW;
import io.aklivity.zilla.engine.drive.internal.types.stream.ResetFW;
import io.aklivity.zilla.engine.drive.internal.types.stream.SignalFW;
import io.aklivity.zilla.engine.drive.internal.types.stream.WindowFW;
...
public class DispatchAgent implements AxleContext, Agent
{
        ...
        FlushFW flush)
    {
        ...
        if (DriveConfiguration.DEBUG_BUDGETS)
        {
