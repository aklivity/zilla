 ...
 * under the License.
 */
package io.aklivity.zilla.engine.drive.internal.budget;

import static io.aklivity.zilla.engine.drive.internal.layouts.BudgetsLayout.budgetIdOffset;
import static io.aklivity.zilla.engine.drive.internal.layouts.BudgetsLayout.budgetRemainingOffset;
import static io.aklivity.zilla.engine.drive.internal.layouts.BudgetsLayout.budgetWatchersOffset;
...
import io.aklivity.zilla.engine.drive.internal.util.function.LongObjectBiConsumer;
...
public class DefaultBudgetCreditor implements BudgetCreditor, AutoCloseable
{
        ...
        long credit)
    {
        ...
        if (DriveConfiguration.DEBUG_BUDGETS && credit != 0L)
        {
