...
import io.aklivity.zilla.engine.drive.test.DriveRule;
import io.aklivity.zilla.engine.drive.test.annotation.Configuration;

public class DriveIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "io/aklivity/zilla/engine/drive/network")
        .addScriptRoot("app", "io/aklivity/zilla/engine/drive/application");

    private final TestRule timeout = new DisableOnDebug(new Timeout(10, SECONDS));

    private final DriveRule drive = new DriveRule()
        .directory("target/zilla-itests")
        .commandBufferCapacity(1024)
        .responseBufferCapacity(1024)
        .counterValuesBufferCapacity(4096)
        .configurationRoot("io/aklivity/zilla/engine/drive/config")
        .external("app#0")
        .clean();
