...
import io.aklivity.zilla.engine.drive.cog.Configuration.BooleanPropertyDef;
import io.aklivity.zilla.engine.drive.cog.Configuration.BytePropertyDef;
import io.aklivity.zilla.engine.drive.cog.Configuration.CharPropertyDef;
import io.aklivity.zilla.engine.drive.cog.Configuration.ConfigurationDef;
import io.aklivity.zilla.engine.drive.cog.Configuration.DoublePropertyDef;
import io.aklivity.zilla.engine.drive.cog.Configuration.FloatPropertyDef;
import io.aklivity.zilla.engine.drive.cog.Configuration.IntPropertyDef;
import io.aklivity.zilla.engine.drive.cog.Configuration.LongPropertyDef;
import io.aklivity.zilla.engine.drive.cog.Configuration.PropertyDef;
import io.aklivity.zilla.engine.drive.cog.Configuration.ShortPropertyDef;
import io.aklivity.zilla.engine.drive.cog.Configuration.ToByteFunction;
import io.aklivity.zilla.engine.drive.cog.Configuration.ToCharFunction;
import io.aklivity.zilla.engine.drive.cog.Configuration.ToFloatFunction;
import io.aklivity.zilla.engine.drive.cog.Configuration.ToShortFunction;
