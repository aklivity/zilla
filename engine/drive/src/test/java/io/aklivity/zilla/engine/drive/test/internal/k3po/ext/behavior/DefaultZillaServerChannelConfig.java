...
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.behavior.ZillaChannel.NATIVE_BUFFER_FACTORY;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.behavior.ZillaThrottleMode.NONE;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.behavior.ZillaTransmission.SIMPLEX;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.types.ZillaTypeSystem.OPTION_BUDGET_ID;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.types.ZillaTypeSystem.OPTION_BYTE_ORDER;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.types.ZillaTypeSystem.OPTION_CAPABILITIES;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.types.ZillaTypeSystem.OPTION_PADDING;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.types.ZillaTypeSystem.OPTION_SHARED_WINDOW;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.types.ZillaTypeSystem.OPTION_THROTTLE;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.types.ZillaTypeSystem.OPTION_TRANSMISSION;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.types.ZillaTypeSystem.OPTION_UPDATE;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.types.ZillaTypeSystem.OPTION_WINDOW;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.util.Conversions.convertToByte;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.util.Conversions.convertToInt;
import static io.aklivity.zilla.engine.drive.test.internal.k3po.ext.util.Conversions.convertToLong;
...
public class DefaultZillaServerChannelConfig extends DefaultServerChannelConfig implements ZillaServerChannelConfig
{
        ...
        Object value)
    {
        ...
        {
            setTransmission(ZillaTransmission.decode(Objects.toString(value, "simplex")));
        }
        ...
        {
            setThrottle(ZillaThrottleMode.decode(Objects.toString(value, "stream")));
        }
